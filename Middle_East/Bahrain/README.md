# 🇧🇭 Bahrain Exposure Model

This page provides an overview of the exposure model for Bahrain, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 289.3 thousand buildings, USD 76.1 billion in replacement cost, and 1.6 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Bahrain | COM | 34.5 K |  | 17.5 B | 12.8 M | 8.1 M |
| Bahrain | IND | 16.8 K |  | 7.8 B | 7.0 M | 3.7 M |
| Bahrain | RES | 238.0 K | 1.6 M | 50.9 B | 50.8 M | 19.9 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_BHR.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|
| RES | Census 2020<br>Census 2010 |  | 2020 | 2025.0 | 1 |  |  |  |
| IND, COM | Enterprise Survey, 2006<br>Census 2010 |  | 2010 | 2025.0 | 1 |  |  |  |
