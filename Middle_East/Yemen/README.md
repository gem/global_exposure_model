# 🇾🇪 Yemen Exposure Model

This page provides an overview of the exposure model for Yemen, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 5.9 million buildings, USD 192.8 billion in replacement cost, and 41.8 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Yemen | COM | 0.3 M |  | 28.7 B | 67.8 M | 38.7 M |
| Yemen | IND | 0.1 M |  | 14.2 B | 24.4 M | 12.9 M |
| Yemen | RES | 5.6 M | 41.8 M | 149.9 B | 681.5 M | 234.4 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_YEM.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | Statistical Year Book 2017 |  | 2017 | 2025.0 | 1 |  |  |  |  |
| IND, COM | Statistical Year Book 2017<br>Census 2004<br>Labour Force Survey 2013-4 |  | 2017 | 2025.0 | 1 |  |  |  |  |
| OCCUPANTS |  |  | 2021 | 2025.0 | as for RES |  |  |  | Occupants were adjusted to 2021 but there is still a 16% with UNPP population for that year |
