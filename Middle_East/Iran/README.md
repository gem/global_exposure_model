...
This page provides an overview of the exposure model for Iran, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 17.5 million buildings, USD 976.4 billion in replacement cost, and 92.4 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Iran | COM | 1.9 M |  | 80.5 B | 0.3 B | 0.2 B |
| Iran | IND | 0.1 M |  | 76.6 B | 0.2 B | 0.1 B |
| Iran | RES | 15.5 M | 92.4 M | 819.3 B | 3.1 B | 1.2 B |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_IRN.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | Population and Housing Census | Statistical Centre of Iran (SCI) | 2011 | 2025.0 | 1 | Dwelling type<br>Construction material<br>Year of construction |  | https://irandataportal.syr.edu/2011-census | The original census information at ADM1 is in Farsi and was translated with the help of a local collaborator |
| COM | Iran Statistical Yearbooks: <br>Trade, Hotels and Restaurants,<br>Transport, Storage and Communications, Culture and Tourism, International Statistics, Labour Force | Statistical Centre of Iran (SCI) | 2012 | 2025.0 | 1 | Economic sector<br>Number of enterprises <br>Size of enterprises |  | https://irandataportal.syr.edu/socio-economic-data/statistical-yearbook |  |
| IND | Iran Statistical Yearbooks: <br>Mining and Quarrying, Agriculture, Forestry and Fisheries, Water and Electricity, Transport, Storage and Communications, International Statistics, Labour Force | Statistical Centre of Iran (SCI) | 2012 | 2025.0 | 1 | Industry<br>Number of enterprises<br>Size of enterprises |  | https://irandataportal.syr.edu/socio-economic-data/statistical-yearbook |  |
| OCCUPANTS |  | Statistical Centre of Iran (SCI) | 2011 | 2025.0 | as for RES |  |  | https://irandataportal.syr.edu/2011-census |  |
| BOUNDARIES | GAUL | GAUL | 2025 |  | 1 | Administrative divisions at level 1 | CC BY 4.0 | https://data.apps.fao.org/catalog/iso/34f97afc-6218-459a-971d-5af1162d318a | A waterbody from the origginal GAUL's file was manually deleted |
