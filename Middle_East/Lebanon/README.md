# 🇱🇧 Lebanon Exposure Model

This page provides an overview of the exposure model for Lebanon, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 578.1 thousand buildings, USD 221.9 billion in replacement cost, and 5.8 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Lebanon | COM | 76.9 K |  | 28.9 B | 27.8 M | 18.2 M |
| Lebanon | IND | 13.3 K |  | 6.7 B | 5.5 M | 2.9 M |
| Lebanon | RES | 488.0 K | 5.8 M | 186.4 B | 184.3 M | 66.0 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_LBN.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | Labour Force and Household Living Conditions Survey 2018-2019<br>Living Conditions Survey 2007 |  | 2019 | 2025.0 | 1 |  |  |  |  |
| IND, COM | Census of Buildings, Dwellings, and Establishments 2004 |  | 2004 | 2025.0 | 1 |  |  |  |  |
| OCCUPANTS |  |  | 2019 | 2025.0 | as for RES |  |  |  |  |
| BOUNDARIES | GeoBoundaries | GeoBoundaries | 2025 |  | 1 | Administrative divisions at level 1 | CC BY 4.0 | https://www.geoboundaries.org/countryDownloads.html | Boundaries changed, models were adapted to match the targt source new divisions |
