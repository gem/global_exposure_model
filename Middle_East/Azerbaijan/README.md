# 🇦🇿 Azerbaijan Exposure Model

This page provides an overview of the exposure model for Azerbaijan, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 1.6 million buildings, USD 140.4 billion in replacement cost, and 10.4 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Azerbaijan | COM | 0.1 M |  | 24.1 B | 39.8 M | 24.2 M |
| Azerbaijan | IND | 0.1 M |  | 14.7 B | 22.1 M | 11.6 M |
| Azerbaijan | RES | 1.5 M | 10.4 M | 101.6 B | 222.3 M | 98.5 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_AZE.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | AZSTAT 2021 |  | 2018 | 2025.0 | 1 |  |  |  |  |
| IND, COM | Micro, small and medium entrepreneurship in Azerbaijan 2022 |  | 2022 | 2025.0 | 1 |  |  |  |  |
| OCCUPANTS |  |  | 2021 | 2025.0 | as for RES |  |  |  |  |
| BOUNDARIES | OSM | OSM | 2025 |  | 1 | Administrative divisions at level 1 | ODbL | https://osm-boundaries.com/about/documentation#downloading-the-data | Boundaries changed, models were adapted to match the targt source new divisions |
