...
# Middle East Exposure Model

## ✨ Overview

> The `v2026.0.0` release for the Middle East exposure model is now available! 🥳 🚀

This repository contains the latest exposure model files for the countries and territories in **Middle East**.
...
| COUNTRY | ISO3 |
|---------|------|
| [Armenia](Armenia/README.md) | ARM |
| [Azerbaijan](Azerbaijan/README.md) | AZE |
| [Bahrain](Bahrain/README.md) | BHR |
| [Georgia](Georgia/README.md) | GEO |
| [Iran](Iran/README.md) | IRN |
| [Iraq](Iraq/README.md) | IRQ |
| [Israel](Israel/README.md) | ISR |
| [Jordan](Jordan/README.md) | JOR |
| [Kuwait](Kuwait/README.md) | KWT |
| [Lebanon](Lebanon/README.md) | LBN |
| [Oman](Oman/README.md) | OMN |
| [Palestine](Palestine/README.md) | PSE |
| [Qatar](Qatar/README.md) | QAT |
| [Saudi_Arabia](Saudi_Arabia/README.md) | SAU |
| [Syria](Syria/README.md) | SYR |
| [United_Arab_Emirates](United_Arab_Emirates/README.md) | ARE |
| [Yemen](Yemen/README.md) | YEM |
</details>

## 📊 Regional summary

The regional exposure includes the distribution of buildings, replacement value, and exposed population across all countries in **Middle East**. The regional exposure includes 48.9 million buildings, USD 6.2 trillion in replacement cost, and 317.3 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 5. See [Adm0 summary table](_region/Exposure_Middle_East_Adm0.csv) for additional national level metrics.
...
_Table: Regional exposure model summary per country in Middle East. See [Adm0 summary table](_region/Exposure_Middle_East_Adm0.csv) for the comple list of national level metrics._

| COUNTRY | BUILDINGS | OCCUPANTS | REPLACEMENT COST (USD) | BUILT-UP AREA (SQM) | EMBODIED CARBON (TON) |
|---|---|---|---|---|---|
| Iran | 17.5 M | 92.4 M | 1.0 T | 3.6 B | 1.4 B |
| Iraq | 7.5 M | 47.0 M | 0.5 T | 1.1 B | 0.5 B |
| Yemen | 5.9 M | 41.8 M | 0.2 T | 0.8 B | 0.3 B |
| Syria | 3.7 M | 25.6 M | 0.2 T | 0.7 B | 0.3 B |
| Saudi Arabia | 3.4 M | 34.6 M | 1.5 T | 1.3 B | 0.6 B |
| Azerbaijan | 1.6 M | 10.4 M | 0.1 T | 0.3 B | 0.1 B |
| Jordan | 1.4 M | 11.5 M | 0.4 T | 0.4 B | 0.2 B |
| Oman | 1.4 M | 5.5 M | 0.1 T | 0.2 B | 0.1 B |
| Israel | 1.3 M | 9.5 M | 0.9 T | 0.4 B | 0.2 B |
| Georgia | 0.9 M | 3.8 M | 0.1 T | 0.2 B | 0.1 B |
| United Arab Emirates | 0.8 M | 11.3 M | 0.5 T | 0.3 B | 0.1 B |
| Kuwait | 0.7 M | 5.0 M | 0.1 T | 0.2 B | 0.1 B |
| Armenia | 0.7 M | 3.0 M | 0.1 T | 0.1 B | 0.1 B |
| Palestine | 0.6 M | 5.3 M | 0.2 T | 0.2 B | 0.1 B |
| Lebanon | 0.6 M | 5.8 M | 0.2 T | 0.2 B | 0.1 B |
...
Motamed, Hooman, Alejandro Calderon, Vitor Silva, and Catarina Costa. "Development of a probabilistic earthquake loss model for Iran." *Bulletin of earthquake engineering 17, no. 4* (2019): 1795-1823.

For countries in the Arabian Peninsula and the Levant (except Israel) in the `v2018.0.0` release:
...
For Palestine in the `v2023.0.0` release:

Exposure and vulnerability assessment and full module with maps and tools. Integrating Resilience in Local Governance in West Bank and Gaza (WB&G) project, prepared by Urban Planning and Disaster Risk Reduction Center (UPDRRC) of An-Najah National University for Municipal Development and Lending Fund (MDLF), 2022.
