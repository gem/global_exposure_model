# 🇱🇰 Sri_Lanka Exposure Model

This page provides an overview of the exposure model for Sri_Lanka, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 7.7 million buildings, USD 117.5 billion in replacement cost, and 23.2 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Sri Lanka | COM | 0.1 M |  | 5.8 B | 10.5 M | 6.6 M |
| Sri Lanka | IND | 0.0 M |  | 3.8 B | 8.8 M | 4.8 M |
| Sri Lanka | RES | 7.6 M | 23.2 M | 107.9 B | 532.0 M | 255.2 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_LKA.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | Census of Population and Housing | Department of Census and Statistics of Sri Lanka | 2012 | 2025.0 | 2 | Type of housing structure<br>Material of wall<br>Material of floor<br>Material of roof<br>Possible info with year of construction (not available online) |  | http://www.statistics.gov.lk/PopHouSat/CPH2011/index.php?fileName=Activities/TentativelistofPublications<br>http://www.statistics.gov.lk/PopHouSat/CPH2011/index.php?fileName=Finalhousing&gp=Activities&tpl=3 |  |
| IND, COM | Economic Census<br>Atlas of economic activities | Department of Census and Statistics of Sri Lanka | 2013-2014 | 2025.0 | 2 | Economic Activities |  | http://www.statistics.gov.lk/Economic/Economic%20Census.html |  |
| OCCUPANTS |  |  | 2012 | 2025.0 | as for RES |  |  | http://www.statistics.gov.lk/PopHouSat/CPH2011/index.php?fileName=P2&gp=Activities&tpl=3 |  |
| BOUNDARIES | World Bank | World Bank | 2025 |  | 1 | Administrative divisions at level 1 | CC BY 4.0 | https://datacatalog.worldbank.org/search/dataset/0038272/world-bank-official-boundaries | In the previous model, the administrative boundaries were at the Adm2 level. The upper-level Adm1 was added, and all files were updated consistently. The borders between ADM1 and Adm2 match. |
