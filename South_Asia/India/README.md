# 🇮🇳 India Exposure Model

This page provides an overview of the exposure model for India, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 263.5 million buildings, USD 3.5 trillion in replacement cost, and 1.5 billion occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| India | COM | 25.3 M |  | 0.7 T | 1.9 B | 0.8 B |
| India | IND | 5.2 M |  | 0.2 T | 0.5 B | 0.3 B |
| India | RES | 233.0 M | 1.5 B | 2.6 T | 17.3 B | 5.1 B |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_IND.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | 15th Census of India | Office of the Registrar General and Census Commissioner of India | 2011 | 2025.0 | 5 | Use of building<br>Wall material<br>Floor material<br>Settlement type (urban / rural)<br>Slum dwellings |  | https://censusindia.gov.in/census.website/data/census-tables | Updated during model devel (see WIP) |
| IND, COM | 15th Census of India | Office of the Registrar General and Census Commissioner of India | 2011 | 2025.0 | 3 | Use of building<br>Wall material<br>Settlement type (urban / rural) |  | https://censusindia.gov.in/census.website/data/census-tables | Updated during model devel (see WIP) |
| OCCUPANTS |  |  | 2020 | 2025.0 | as for RES |  |  |  |  |
