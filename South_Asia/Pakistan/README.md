# 🇵🇰 Pakistan Exposure Model

This page provides an overview of the exposure model for Pakistan, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 38.9 million buildings, USD 853.0 billion in replacement cost, and 255.2 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Pakistan | COM | 2.7 M |  | 99.3 B | 0.3 B | 0.2 B |
| Pakistan | IND | 0.8 M |  | 51.7 B | 0.3 B | 0.2 B |
| Pakistan | RES | 35.4 M | 255.2 M | 701.9 B | 3.0 B | 1.2 B |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_PAK.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | 7th Population and Housing Census | Pakistan Bureau of Statistics | 2023 | 2025.0 | 3 | Population<br>Buildings<br>Households |  | https://www.pbs.gov.pk/digital-census/detailed-results | Residential Buildings. Census data cover Pakistan provinces only.<br>Gilgit Baltistan: 2022 Development Statistics (in data_ref)<br>Azad Jammu and Kashmir: 2022 Azad Jammu & Kashmir at a Glance (in data_ref) |
| COM | 7th Population and Housing Census<br>Economic Survey | Pakistan Bureau of Statistics | 2023 | 2025.0 | 3 | Buildings<br>GDP |  | https://www.pbs.gov.pk/digital-census/detailed-results<br>https://www.finance.gov.pk/survey_2023.html | Economic Buildings. Survey data cover Pakistan provinces only.<br>Gilgit Baltistan: 2022 Development Statistics (in data_ref)<br>Azad Jammu and Kashmir: 2022 Statistical Yearbook (in data_ref) |
| IND | 7th Population and Housing Census<br>Economic Survey | Pakistan Bureau of Statistics | 2023 | 2025.0 | 3 | Buildings<br>GDP |  | https://www.pbs.gov.pk/digital-census/detailed-results<br>https://www.finance.gov.pk/survey_2023.html | Economic Buildings. Survey data cover Pakistan provinces only. |
| OCCUPANTS |  |  | 2023 | 2025.0 | as for RES |  |  |  |  |
