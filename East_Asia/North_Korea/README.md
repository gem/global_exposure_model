# 🇰🇵 North_Korea Exposure Model

This page provides an overview of the exposure model for North_Korea, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 2.8 million buildings, USD 128.8 billion in replacement cost, and 26.6 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| North Korea | COM | 0.1 M |  | 5.9 B | 19.1 M | 12.0 M |
| North Korea | IND | 0.0 M |  | 5.2 B | 14.5 M | 7.0 M |
| North Korea | RES | 2.7 M | 26.6 M | 117.7 B | 493.4 M | 210.6 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_PRK.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | Socio-economic, Demographic, and Health Survey 2014<br>Population Census 2008 | Central Bureau of Statistics (CBS) | 2014 | 2025.0 | 1 | Households<br>Housing type |  | https://dprkorea.un.org/en/10162-2014-socio-economic-demographic-and-health-survey | Most recent Population Census was in year 2008 |
| IND, COM | International Labour Organization (ILO) | International Labour Organization (ILO) | 2019 | 2025.0 | 0 |  |  | https://www.ilo.org/global/lang--en/index.htm | Data essentially non-existant, International Labour Organization (ILO) estimates were used |
| OCCUPANTS | Socio-economic, Demographic, and Health Survey 2014<br>Population Census 2008 | Central Bureau of Statistics (CBS) | 2014 | 2025.0 | 1 |  |  | https://dprkorea.un.org/en/10162-2014-socio-economic-demographic-and-health-survey | Since the publications are relatively out-of-date, the population was increased from the 2014 values to 2021 values using the United Nation’s World Population Prospects. |
| BOUNDARIES | OSM | OSM | 2025 |  | 1 | Administrative divisions at level 1 | ODbL | https://osm-boundaries.com/about/documentation#downloading-the-data | Administrative divisions changed at the time of standardization to ADM1. The ADM1 level was taken directly from the source without modifications, and the models were adapted accordingly. |
