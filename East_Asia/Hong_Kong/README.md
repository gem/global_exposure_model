# 🇭🇰 Hong_Kong Exposure Model

This page provides an overview of the exposure model for Hong_Kong, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 41.7 thousand buildings, USD 1.5 trillion in replacement cost, and 7.0 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Hong Kong | COM | 5.2 K |  | 0.2 T | 63.9 M | 40.3 M |
| Hong Kong | IND | 1.1 K |  | 0.0 T | 1.9 M | 1.1 M |
| Hong Kong | RES | 35.4 K | 7.0 M | 1.3 T | 521.6 M | 230.5 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_HKG.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|
| RES, COM, IND | Hong Kong Housing Authority Estates<br>Hong Kong Housing Society Estates<br>Building Management: Database of all Private Buildings in Hong Kong<br>Database of shopping centers<br>Database of “flatted” factories | Various | 2020 | 2025.0 | Bldg | Building footprint<br>Building height<br>Building use |  | https://bmis2.buildingmgt.gov.hk/bd_hadbiex/content/searchbuilding/building_search.jsf?renderedValue=true<br>https://data.gov.hk/en-data/dataset/hk-rvd-tsinfo_rvd-names-of-buildings<br>https://www.housingauthority.gov.hk/en/global-elements/estate-locator/index.html |
| OCCUPANTS | Mid-year population for 2018 | Census and Statistics Department | 2018 | 2025.0 | as for RES |  |  | https://www.censtatd.gov.hk/en/press_release_detail.html?id=4272 |
| BOUNDARIES | Official | Development Bureau of the Government of the Hong Kong Special Administrative Region | 2025 |  | 1 | Administrative divisions at level 1 | https://portal.csdi.gov.hk/csdi-webpage/doc/TNC | https://data.gov.hk/en-data/dataset/hk-had-json1-hong-kong-administrative-boundaries |
