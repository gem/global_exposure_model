# 🇲🇴 Macao Exposure Model

This page provides an overview of the exposure model for Macao, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 5.0 thousand buildings, USD 137.7 billion in replacement cost, and 638.6 thousand occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Macao | COM | 0.9 K |  | 24.8 B | 11.7 M | 7.2 M |
| Macao | IND | 0.6 K |  | 0.4 B | 0.3 M | 0.2 M |
| Macao | RES | 3.5 K | 638.6 K | 112.4 B | 63.6 M | 28.4 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_MAC.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | 15th Population Census and 5th Housing Census of 2011 | Statistics and Census Service (DSEC) | 2011 | 2025.0 | 2 | Year of completion<br>Number of storeys<br>Type of housing |  | https://www.dsec.gov.mo/en-US/Statistic?id=104 |  |
| IND, COM | Macao Industry Overview | Statistics and Census Service (DSEC) | 2020 | 2025.0 | 2 | Number of establishments by sector |  | https://www.dsec.gov.mo/en-US/Statistic?id=8 |  |
| OCCUPANTS | Population by-Census of 2016 | Statistics and Census Service (DSEC) | 2016 | 2025.0 | 2 |  |  |  | WB figures for population reflect year 2010 |
| BOUNDARIES | GADM | GADM | 2025 |  | 1 | Administrative divisions at level 1 | https://gadm.org/license.html | https://geodata.ucdavis.edu/gadm/gadm3.6/shp/gadm36_MAC_shp.zip |  |
