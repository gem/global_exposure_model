# 🇰🇷 South_Korea Exposure Model

This page provides an overview of the exposure model for South_Korea, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 8.7 million buildings, USD 3.8 trillion in replacement cost, and 51.7 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| South Korea | COM | 1.6 M |  | 0.8 T | 0.5 B | 305.1 M |
| South Korea | IND | 0.5 M |  | 0.4 T | 0.3 B | 174.7 M |
| South Korea | RES | 6.6 M | 51.7 M | 2.6 T | 1.8 B | 762.3 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_KOR.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | Population and Housing Census 2020 | Korean Statistical Information Service (KOSIS) | 2020 | 2025.0 | 1 | Population, houses, and housing units<br>Housing unit type, area, and household size |  | https://kosis.kr/eng/ | Wall material data was additionally investigated from the Ministry of Land, Infrastructure and Transport (MOLIT) from 2015 |
| IND, COM | Census of Establishments 2020 | Korean Statistical Information Service (KOSIS) | 2020 | 2025.0 | 1 | Number of establishments<br>Number of workers |  | https://kosis.kr/eng/ |  |
| OCCUPANTS | Population and Housing Census 2020 | Korean Statistical Information Service (KOSIS) | 2020 | 2025.0 | as for RES |  |  |  | Data is available online, with most relevant statistics available annually. |
