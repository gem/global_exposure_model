# 🇯🇲 Jamaica Exposure Model

This page provides an overview of the exposure model for Jamaica, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 1.0 million buildings, USD 104.3 billion in replacement cost, and 2.8 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Jamaica | COM | 62.1 K |  | 15.8 B | 14.9 M | 6.2 M |
| Jamaica | IND | 15.3 K |  | 10.2 B | 10.1 M | 4.2 M |
| Jamaica | RES | 940.2 K | 2.8 M | 78.3 B | 92.4 M | 35.4 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_JAM.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|
| RES | Population and Housing Census | Statistical Institute of Jamaica | 2011 | 2025.0 | 1 | Outer wall construction material<br>Main roofing material |  | https://redatam.org/es/procesar-en-linea/caribe/jam |
| COM | Labor Force Indicators, Directory of Business and Establishments | Statistical Institute of Jamaica | 2011 | 2025.0 | 1 | Number of establishments in the country<br>Number of workers per economic sector |  | https://statinja.gov.jm/ |
| IND | Labor Force Indicators, Directory of Business and Establishments | Statistical Institute of Jamaica | 2011 | 2025.0 | 1 | Number of establishments in the country<br>Number of workers per economic sector |  | https://statinja.gov.jm/ |
