# 🇧🇧 Barbados Exposure Model

This page provides an overview of the exposure model for Barbados, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 109.9 thousand buildings, USD 22.8 billion in replacement cost, and 282.6 thousand occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Barbados | COM | 4.2 K |  | 3.6 B | 2.3 M | 1.1 M |
| Barbados | IND | 1.5 K |  | 0.9 B | 0.6 M | 0.3 M |
| Barbados | RES | 104.2 K | 282.6 K | 18.3 B | 15.9 M | 5.9 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_BRB.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|
| RES | Population and Housing Census | Barbados Statistical Service | 2010 | 2025.0 |  | Outer wall construction material<br>Year of construction |  | https://stats.gov.bb/ |
| IND, COM |  |  | 2010 | 2025.0 |  |  |  |  |
| OCCUPANTS | Population and Housing Census |  | 2010 | 2025.0 | as for RES |  |  |  |
