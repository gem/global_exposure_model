# 🇵🇦 Panama Exposure Model

This page provides an overview of the exposure model for Panama, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 1.1 million buildings, USD 168.3 billion in replacement cost, and 4.5 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Panama | COM | 0.0 M |  | 23.0 B | 22.2 M | 9.7 M |
| Panama | IND | 0.0 M |  | 11.9 B | 13.3 M | 5.5 M |
| Panama | RES | 1.1 M | 4.5 M | 133.4 B | 147.7 M | 56.3 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_PAN.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | Population and Housing Census | Instituto Nacional de Estadisticas y Censos | 2023 | 2025.0 | 3 | Dwelling type<br>Outer wall construction material<br>Main flooring material<br>Roof material<br>Urban Rural |  | https://www.inec.gob.pa/ |  |
| COM | Labor Force Indicators, Directory of Business and Establishments | Instituto Nacional de Estadisticas y Censos | 2010 | 2025.0 | 1 | Number of establishments by economic sector<br>Number of employees per establishment |  | https://www.inec.gob.pa/ |  |
| IND | Labor Force Indicators, Directory of Business and Establishments | Instituto Nacional de Estadisticas y Censos | 2010 | 2025.0 | 1 | Number of establishments by economic sector<br>Number of employees per establishment |  | https://www.inec.gob.pa/ |  |
| OCCUPANTS |  |  | 2023 | 2025.0 | as for RES | Totals, Gender |  | https://www.inec.gob.pa/ |  |
| BOUNDARIES | Límites Político-Administrativos de la República de Panamá | Instituto Geográfico Nacional Tommy Guardia | 2025 |  | 1 | Administrative divisions at level 1 | CC BY-NC-SA 4.0 | https://osm-https://ignpanama.anati.gob.pa/index.php/2-uncategorised/268-division-politica-administrativa | Water bodies from the original target source GPKG were removed. The Naso Tjër Di Indigenous Territory is represented at the district level in the source but functions at the province level, so the map was manually adjusted accordingly. The license allows this modification. |
