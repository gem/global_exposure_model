# 🇦🇬 Antigua_and_Barbuda Exposure Model

This page provides an overview of the exposure model for Antigua_and_Barbuda, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 32.0 thousand buildings, USD 10.7 billion in replacement cost, and 94.2 thousand occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Antigua and Barbuda | COM | 3.0 K |  | 1.1 B | 0.9 M | 0.3 M |
| Antigua and Barbuda | IND | 0.8 K |  | 0.4 B | 0.3 M | 0.1 M |
| Antigua and Barbuda | RES | 28.3 K | 94.2 K | 9.1 B | 9.1 M | 1.9 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_ATG.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
| BOUNDARIES | World Bank | World Bank | 2025 |  | 1 | Administrative divisions at level 1 | CC BY 4.0 | https://datacatalog.worldbank.org/search/dataset/0038272/world-bank-official-boundaries | The administrative divisions at level 1 match; there were no major changes. There is no information for Redonda |
