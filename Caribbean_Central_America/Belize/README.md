# 🇧🇿 Belize Exposure Model

This page provides an overview of the exposure model for Belize, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 66.4 thousand buildings, USD 8.2 billion in replacement cost, and 422.9 thousand occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Belize | COM | 6.8 K |  | 1.3 B | 1.4 M | 0.6 M |
| Belize | IND | 1.6 K |  | 0.4 B | 0.5 M | 0.2 M |
| Belize | RES | 58.0 K | 422.9 K | 6.5 B | 8.7 M | 3.4 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_BLZ.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|
| RES | Population and Housing Census | Statistical Institute of Belize | 2010 | 2025.0 | 1 | Dwelling type<br>Outer wall construction material<br>Main roofing material<br>Main flooring material |  | https://redatam.org/es/procesar-en-linea/caribe/blz |
| COM | Labor Force Indicators, Directory of Business and Establishments | Statistical Institute of Belize | 2010 | 2025.0 | 1 | Number of establishments by economic sector |  | https://sib.org.bz/ |
| IND | Labor Force Indicators, Directory of Business and Establishments | Statistical Institute of Belize | 2010 | 2025.0 | 1 | Number of establishments by economic sector |  | https://sib.org.bz/ |
