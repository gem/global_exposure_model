# 🇬🇹 Guatemala Exposure Model

This page provides an overview of the exposure model for Guatemala, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 5.0 million buildings, USD 318.7 billion in replacement cost, and 18.7 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Guatemala | COM | 0.1 M |  | 27.4 B | 35.9 M | 15.8 M |
| Guatemala | IND | 0.0 M |  | 16.7 B | 27.0 M | 12.3 M |
| Guatemala | RES | 4.9 M | 18.7 M | 274.6 B | 456.2 M | 195.2 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_GTM.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|
| RES | Population and Housing Census | Instituto Nacional de Estadisticas | 2018 | 2025.0 | 3 | Outer wall construction material, Roof Type, Floor Type, Dwelling Type, Urban Rural |  | https://censo2018.ine.gob.gt/ |
| COM | Labor Force Indicators, Directory of Business and Establishments | Instituto Nacional de Estadisticas | 2002 | 2025.0 | 1 | Number of establishments by province<br>Number of establishments by economic sector |  | https://www.ine.gob.gt/ |
| IND | Labor Force Indicators, Directory of Business and Establishments | Instituto Nacional de Estadisticas | 2002 | 2025.0 | 1 | Number of establishments by province<br>Number of establishments by economic sector |  | https://www.ine.gob.gt/ |
| OCCUPANTS |  |  | 2018 | 2025.0 | as for RES | Totals, Gender, Age, Disabled or Impaired, Employment |  | https://censo2018.ine.gob.gt/ |
