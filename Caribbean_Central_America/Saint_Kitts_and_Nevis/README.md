# 🇰🇳 Saint_Kitts_and_Nevis Exposure Model

This page provides an overview of the exposure model for Saint_Kitts_and_Nevis, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 18.1 thousand buildings, USD 6.8 billion in replacement cost, and 46.9 thousand occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Saint Kitts and Nevis | COM | 1.2 K |  | 0.4 B | 0.3 M | 0.1 M |
| Saint Kitts and Nevis | IND | 0.4 K |  | 0.3 B | 0.3 M | 0.1 M |
| Saint Kitts and Nevis | RES | 16.5 K | 46.9 K | 6.1 B | 5.8 M | 2.3 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_KNA.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
| OCCUPANTS | GED4GEM | Global Earthquake Model Foundation | 2012 | 2025.0 | as for RES |  |  | https://platform.openquake.org/ |
