# 🇹🇹 Trinidad_and_Tobago Exposure Model

This page provides an overview of the exposure model for Trinidad_and_Tobago, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 437.3 thousand buildings, USD 49.8 billion in replacement cost, and 1.5 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Trinidad and Tobago | COM | 7.3 K |  | 3.1 B | 2.7 M | 1.2 M |
| Trinidad and Tobago | IND | 21.4 K |  | 6.3 B | 6.3 M | 2.5 M |
| Trinidad and Tobago | RES | 408.6 K | 1.5 M | 40.4 B | 47.1 M | 17.5 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_TTO.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|
| RES | Population and Housing Census | Central Statistical Office | 2011 | 2025.0 | 1 | Outer wall construction material<br>Main roofing material |  | https://redatam.org/es/procesar-en-linea/caribe/tto |
| COM | Labor Force Indicators, Directory of Business and Establishments | Central Statistical Office | 2011 | 2025.0 | 0 | Number of workers per economic sector |  | https://cso.gov.tt/ |
| IND | Labor Force Indicators, Directory of Business and Establishments | Central Statistical Office | 2011 | 2025.0 | 0 | Number of workers per economic sector |  | https://cso.gov.tt/ |
