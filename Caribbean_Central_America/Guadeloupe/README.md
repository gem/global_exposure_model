# 🇬🇵 Guadeloupe Exposure Model

This page provides an overview of the exposure model for Guadeloupe, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 154.2 thousand buildings, USD 75.2 billion in replacement cost, and 373.8 thousand occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Guadeloupe | COM | 4.2 K |  | 2.9 B | 1.5 M | 0.6 M |
| Guadeloupe | IND | 2.5 K |  | 2.4 B | 1.2 M | 0.4 M |
| Guadeloupe | RES | 147.5 K | 373.8 K | 69.9 B | 38.4 M | 15.3 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_GLP.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|
| RES, IND, COM | GED4GEM | Global Earthquake Model Foundation | 2012 | 2025.0 | 3 | Building construction material<br>Building formality<br>Bulding height range |  | https://platform.openquake.org/ |
