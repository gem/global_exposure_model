# 🇭🇹 Haiti Exposure Model

This page provides an overview of the exposure model for Haiti, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 2.9 million buildings, USD 86.3 billion in replacement cost, and 11.9 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Haiti | COM | 0.2 M |  | 9.3 B | 18.4 M | 8.0 M |
| Haiti | IND | 0.1 M |  | 2.6 B | 6.1 M | 2.8 M |
| Haiti | RES | 2.7 M | 11.9 M | 74.4 B | 170.9 M | 35.2 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_HTI.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | Global Human Settlement Layers,  Projections of population,  Population and Houing Censsus | European Commission, Joint Research Centre (JRC)<br>Institut Haitien<br>de Statistique et d'Informatique | 2024, 2003 | 2025.0 | 4 | Population distribution<br>Number of inhabitants per dwelling<br>Population projection |  | https://ghsl.jrc.ec.europa.eu/download.php | 2003 national census counts were updated based on population and household projections using 2024 GHS_POP distribution |
| IND, COM | Indicador de la actividad economica total, Labour force indicators, Enterprice surveys data set | Institut Haitien<br>de Statistique et d'Informatique, World bank group | 2024, 2019 | 2025.0 | 0 | Number of establishments by economic sector<br>Number of employees per establishment<br>Labour force |  | https://ihsi.gouv.ht/<br>https://microdata.worldbank.org/index.php/catalog/3756/download/48610 | Base reference is original model with REF_YEAR 2019, updated using economic activity indicators from statistical office from 2024 and WBDI |
| OCCUPANTS | 2024 GHS_POP dataset |  | 2024 | 2025.0 | 0 |  |  | https://ihsi.gouv.ht/<br>https://microdata.worldbank.org/index.php/catalog/3756/download/48610 | Total coming from 2024 oficial projections, updated and distributed using 2024 GHS_POP dataset |
