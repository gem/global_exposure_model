# 🇳🇮 Nicaragua Exposure Model

This page provides an overview of the exposure model for Nicaragua, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 1.5 million buildings, USD 60.9 billion in replacement cost, and 6.7 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Nicaragua | COM | 0.1 M |  | 10.7 B | 16.5 M | 6.1 M |
| Nicaragua | IND | 0.0 M |  | 7.7 B | 13.6 M | 5.6 M |
| Nicaragua | RES | 1.4 M | 6.7 M | 42.5 B | 106.3 M | 30.7 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_NIC.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | Population and Housing Census | Instituto Nacional de Información de Desarrollo | 2005 | 2025.0 | 3 | Outer wall construction material<br>Main flooring material |  | https://redatam.org/es/procesar-en-linea/latam/nic |  |
| COM | Labor Force Indicators | Instituto Nacional de Información de Desarrollo | 2005 | 2025.0 | 0 | Number of workers per economic sector |  | https://www.inide.gob.ni/ |  |
| IND | Labor Force Indicators | Instituto Nacional de Información de Desarrollo | 2005 | 2025.0 | 0 | Number of workers per economic sector |  | https://www.inide.gob.ni/ |  |
| OCCUPANTS |  |  | 2021 | 2025.0 | as for RES |  |  |  |  |
| BOUNDARIES | World Bank | World Bank | 2025 |  | 1 | Administrative divisions at level 1 | CC BY 4.0 | https://datacatalog.worldbank.org/search/dataset/0038272/world-bank-official-boundaries | Administrative level 1 divisions were updated, and the models were rebuilt to align with the new target source divisions. |
