# 🇦🇮 Anguilla Exposure Model

This page provides an overview of the exposure model for Anguilla, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 5.0 thousand buildings, USD 1.7 billion in replacement cost, and 14.7 thousand occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Anguilla | COM | 0.9 K |  | 0.3 B | 0.2 M | 83.4 K |
| Anguilla | IND | 0.1 K |  | 0.0 B | 0.0 M | 11.5 K |
| Anguilla | RES | 4.0 K | 14.7 K | 1.3 B | 1.4 M | 511.6 K |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_AIA.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES, IND, COM | GED4GEM | Global Earthquake Model Foundation | 2012 | 2025.0 | 1 | Building construction material<br>Building formality<br>Bulding height range |  | https://platform.openquake.org/ |  |
| OCCUPANTS | United Nations Population Prospects |  | 2020 | 2025.0 | as for RES |  |  | https://population.un.org/wpp |  |
| BOUNDARIES | Caribbean Disaster Emergency Management Agency (CDEMA) | Caribbean Risk Information System (CRIS) | 2025 |  | 1 | Administrative divisions at level 1 | https://www.cdema.org/virtuallibrary/index.php/charim-hbook/use-case-book/9-data-management/9-6-data-sharing | https://geocris2.cdema.org/downloads/ | The license is not clearly specified, but restrictions on the use of the data are not specified either. |
