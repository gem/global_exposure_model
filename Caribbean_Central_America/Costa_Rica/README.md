# 🇨🇷 Costa_Rica Exposure Model

This page provides an overview of the exposure model for Costa_Rica, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 1.6 million buildings, USD 162.2 billion in replacement cost, and 5.1 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Costa Rica | COM | 0.0 M |  | 27.6 B | 29.2 M | 13.4 M |
| Costa Rica | IND | 0.0 M |  | 16.9 B | 22.5 M | 9.4 M |
| Costa Rica | RES | 1.5 M | 5.1 M | 117.6 B | 159.3 M | 51.5 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_CRI.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|
| RES | Population and Housing Census | Instituto Nacional de Estadisticas y Censos | 2011 | 2025.0 | 3 | Dwelling type<br>Outer wall construction material<br>Main roofing material<br>Main flooring material<br>Dwelling quality |  | https://redatam.org/es/procesar-en-linea/latam/cri |
| COM | Labor Force Indicators, Directory of Business and Establishments | Instituto Nacional de Estadisticas y Censos | 2013 | 2025.0 | 2 | Number of establishments by economic sector<br>Number of employees per establishment |  | https://inec.cr/ |
| IND | Labor Force Indicators, Directory of Business and Establishments | Instituto Nacional de Estadisticas y Censos | 2013 | 2025.0 | 2 | Number of establishments by economic sector<br>Number of employees per establishment |  | https://inec.cr/ |
| OCCUPANTS |  |  | 2021 | 2025.0 | as for RES |  |  | https://population.un.org/wpp/ |
