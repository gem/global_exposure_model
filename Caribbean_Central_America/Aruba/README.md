# 🇦🇼 Aruba Exposure Model

This page provides an overview of the exposure model for Aruba, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 25.4 thousand buildings, USD 18.7 billion in replacement cost, and 108.1 thousand occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Aruba | COM | 1.5 K |  | 1.2 B | 0.8 M | 0.3 M |
| Aruba | IND | 0.8 K |  | 1.8 B | 1.3 M | 0.5 M |
| Aruba | RES | 23.2 K | 108.1 K | 15.7 B | 11.9 M | 1.8 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_ABW.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
| BOUNDARIES | GAUL | GAUL | 2025 |  | 1 | Administrative divisions at level 1 | CC BY 4.0 | https://data.apps.fao.org/catalog/iso/34f97afc-6218-459a-971d-5af1162d318a | ADM1 divisions were manually digitized by georeferencing a PNG map, using GAUL as the national reference, as no target sources provided ADM1 boundaries. |
