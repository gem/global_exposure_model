# 🇻🇬 British_Virgin_Islands Exposure Model

This page provides an overview of the exposure model for British_Virgin_Islands, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 10.3 thousand buildings, USD 15.3 billion in replacement cost, and 39.7 thousand occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| British Virgin Islands | COM | 0.8 K |  | 1.6 B | 0.7 M | 0.3 M |
| British Virgin Islands | IND | 0.3 K |  | 2.5 B | 1.1 M | 0.4 M |
| British Virgin Islands | RES | 9.2 K | 39.7 K | 11.1 B | 5.1 M | 1.5 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_VGB.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
| OCCUPANTS | United Nations Population Prospects |  | 2012 | 2025.0 | as for RES |  |  | https://population.un.org/wpp/ |  |
| BOUNDARIES | GAUL | GAUL | 2025 |  | 1 | Administrative divisions at level 1 | CC BY 4.0 | https://data.apps.fao.org/catalog/iso/34f97afc-6218-459a-971d-5af1162d318a | The model was converted from Adm0 to Adm1. The target source gpkg was used to change the models accordignly |
