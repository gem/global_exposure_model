# 🇧🇸 Bahamas Exposure Model

This page provides an overview of the exposure model for Bahamas, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 114.1 thousand buildings, USD 99.5 billion in replacement cost, and 354.8 thousand occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Bahamas | COM | 5.2 K |  | 10.9 B | 6.0 M | 2.7 M |
| Bahamas | IND | 1.3 K |  | 8.2 B | 5.0 M | 1.8 M |
| Bahamas | RES | 107.6 K | 354.8 K | 80.3 B | 53.7 M | 13.8 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_BHS.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
| OCCUPANTS | United Nations Population Prospects |  | 2018 | 2025.0 | as for RES |  |  | https://population.un.org/wpp |  |
| BOUNDARIES | GAUL | GAUL | 2025 |  | 1 | Administrative divisions at level 1 | CC BY 4.0 | https://data.apps.fao.org/catalog/iso/34f97afc-6218-459a-971d-5af1162d318a | Green Turtle Cay” (Bahamas 2024 law) was manually separated from Hope Town (Cays); the target source license allows it, Nevertheless it is important to mention that the models contain no data for the Hope Town islands. |
