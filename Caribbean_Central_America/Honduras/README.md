# 🇭🇳 Honduras Exposure Model

This page provides an overview of the exposure model for Honduras, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 2.5 million buildings, USD 161.8 billion in replacement cost, and 10.9 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Honduras | COM | 0.1 M |  | 32.9 B | 46.2 M | 20.1 M |
| Honduras | IND | 0.0 M |  | 16.2 B | 28.1 M | 11.4 M |
| Honduras | RES | 2.4 M | 10.9 M | 112.7 B | 263.8 M | 75.1 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_HND.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|
| RES | Population and Housing Census | Instituto Nacional de Estadisticas | 2013 | 2025.0 | 3 | Dwelling type<br>Outer wall construction material<br>Main flooring material |  | https://www.ine.gob.hn/V3/ |
| COM | Labor Force Indicators, Directory of Business and Establishments | Instituto Nacional de Estadisticas | 2013 | 2025.0 | 3 | Number of establishments by economic sector<br>Number of employees per establishment |  | https://www.ine.gob.hn/V3/ |
| IND | Labor Force Indicators, Directory of Business and Establishments | Instituto Nacional de Estadisticas | 2013 | 2025.0 | 3 | Number of establishments by economic sector<br>Number of employees per establishment |  | https://human-settlement.emergency.copernicus.eu/ghs_buV2023.php/<br>https://ihsi.gouv.ht/statistiques/statistiques_demographiques_et_sociales |
