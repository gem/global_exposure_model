# 🇹🇨 Turks_and_Caicos_Islands Exposure Model

This page provides an overview of the exposure model for Turks_and_Caicos_Islands, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 72.9 thousand buildings, USD 44.2 billion in replacement cost, and 46.9 thousand occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Turks and Caicos Islands | COM | 7.0 K |  | 3.9 B | 1.9 M | 0.8 M |
| Turks and Caicos Islands | IND | 2.7 K |  | 2.1 B | 1.2 M | 0.5 M |
| Turks and Caicos Islands | RES | 63.2 K | 46.9 K | 38.2 B | 22.4 M | 8.7 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_TCA.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES, IND, COM | GED4GEM | Global Earthquake Model Foundation | 2012 | 2025.0 | 1 | Building construction material
<br>Building formality
<br>Bulding height range |  | https://platform.openquake.org/ |  |
| OCCUPANTS | GED4GEM |  | 2012 | 2025.0 | as for RES |  |  | https://platform.openquake.org/ |  |
| BOUNDARIES | World Bank | World Bank | 2025 |  | 1 | Administrative divisions at level 1 | CC BY 4.0 | https://datacatalog.worldbank.org/search/dataset/0038272/world-bank-official-boundaries | The model was originally at ADM0 and was converted to ADM1 using the target source GPKG and the disaggregation process. |
