# 🇩🇴 Dominican_Republic Exposure Model

This page provides an overview of the exposure model for Dominican_Republic, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 3.4 million buildings, USD 436.1 billion in replacement cost, and 11.5 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Dominican Republic | COM | 0.1 M |  | 34.3 B | 40.4 M | 17.2 M |
| Dominican Republic | IND | 0.0 M |  | 20.1 B | 31.7 M | 12.8 M |
| Dominican Republic | RES | 3.3 M | 11.5 M | 381.8 B | 443.9 M | 187.3 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_DOM.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | Population and Housing Census | Oficina Nacional de Estadisticas | 2022 | 2025.0 | 3 | Dwelling type<br>Outer wall construction material<br>Main flooring material |  | https://www.one.gob.do/datos-y-estadisticas/temas/censos/poblacion-y-vivienda/2022/ |  |
| COM | Labor Force Indicators, Directory of Business and Establishments | Oficina Nacional de Estadisticas | 2009 | 2025.0 | 1 | Number of establishments by municipality<br>Number of establishments by economic sector |  |  |  |
| IND | Labor Force Indicators, Directory of Business and Establishments | Oficina Nacional de Estadisticas | 2009 | 2025.0 | 1 | Number of establishments by municipality<br>Number of establishments by economic sector |  |  |  |
| OCCUPANTS |  |  | 2022 | 2025.0 | as for RES |  |  | https://www.one.gob.do/datos-y-estadisticas/temas/censos/poblacion-y-vivienda/2022/ |  |
| BOUNDARIES | World Bank | World Bank | 2025 |  | 1 | Administrative divisions at level 1 | CC BY 4.0 | https://datacatalog.worldbank.org/search/dataset/0038272/world-bank-official-boundaries | Before standardization, ADM2 fields corresponded to ADM1; administrative levels in the model were adjusted accordingly.The administrative divisions at level 1 (target source) and 2 (previous gpkg) match; there were no major changes. |
