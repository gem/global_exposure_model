# 🇸🇻 El_Salvador Exposure Model

This page provides an overview of the exposure model for El_Salvador, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 2.5 million buildings, USD 222.9 billion in replacement cost, and 6.4 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| El Salvador | COM | 0.2 M |  | 32.3 B | 46.3 M | 25.5 M |
| El Salvador | IND | 0.0 M |  | 6.0 B | 5.6 M | 1.8 M |
| El Salvador | RES | 2.3 M | 6.4 M | 184.6 B | 267.9 M | 123.6 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_SLV.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|
| RES | Ministry of the Environment and Natural Resources - MARN | Ministry of the Environment and Natural Resources - MARN | 2023 | 2025.0 | 3 | Building construction material<br>Building formality<br>Bulding height range<br>Building age<br>Building occupancy type<br>Building roof |  | MARN has published the exposure models online in the webpage of the Direccion General del Observatorio Ambiental: https://www.snet.gob.sv/informacion/?area=sismologia |
| COM | Ministry of the Environment and Natural Resources - MARN | Ministry of the Environment and Natural Resources - MARN | 2023 | 2025.0 | 3 | Building construction material<br>Building formality<br>Bulding height range<br>Building age<br>Building occupancy type<br>Building roof |  | MARN has published the exposure models online in the webpage of the Direccion General del Observatorio Ambiental: https://www.snet.gob.sv/informacion/?area=sismologia |
| IND | Ministry of the Environment and Natural Resources - MARN | Ministry of the Environment and Natural Resources - MARN | 2023 | 2025.0 | 3 | Building construction material<br>Building formality<br>Bulding height range<br>Building age<br>Building occupancy type<br>Building roof |  | MARN has published the exposure models online in the webpage of the Direccion General del Observatorio Ambiental: https://www.snet.gob.sv/informacion/?area=sismologia |
| OCCUPANTS |  |  | 2023 | 2025.0 | as for RES |  |  | MARN has published the exposure models online in the webpage of the Direccion General del Observatorio Ambiental: https://www.snet.gob.sv/informacion/?area=sismologia |
