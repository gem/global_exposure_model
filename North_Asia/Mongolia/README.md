# 🇲🇳 Mongolia Exposure Model

This page provides an overview of the exposure model for Mongolia, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 528.8 thousand buildings, USD 19.3 billion in replacement cost, and 3.5 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Mongolia | COM | 31.4 K |  | 2.6 B | 3.8 M | 2.1 M |
| Mongolia | IND | 10.4 K |  | 1.0 B | 1.6 M | 0.7 M |
| Mongolia | RES | 487.1 K | 3.5 M | 15.8 B | 31.6 M | 10.5 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_MNG.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | Population and Housing Census | National Statistics Office of Mongolia | 2020 | 2025.0 | 2.0 |  |  | https://www.1212.mn/en/statistic/file-library/view/47811341 |  |
| COSTS | Development of Building Inventory Data in Ulaanbaatar, Mongolia for Seismic Loss Mongolia for Seismic Loss Estimation (Tumurbaatar, Z.; Miura, H.; Tsamba, T.) | ISPRS International Journal of Geo-Information | 2022 | 2025.0 |  |  |  | https://www.mdpi.com/2220-9964/11/1/26 | Paper used as a reference for the building costs and to inform the mappings. For the costs, additional values from the census report were used |
| IND, COM | Establishment Census (2016), Report of Labor Force Survey(2020) | National Statistics Office of Mongolia | 2016, 2020 | 2025.0 | 2.0 |  |  |  |  |
| OCCUPANTS | Population and Housing Census | National Statistics Office of Mongolia | 2020 | 2025.0 | 2.0 |  |  |  |  |
| BOUNDARIES | World Bank | World Bank | 2025 |  | 1.0 | Administrative divisions at level 1 | CC BY 4.0 | https://datacatalog.worldbank.org/search/dataset/0038272/world-bank-official-boundaries |  |
