# 🇷🇺 Russia Exposure Model

This page provides an overview of the exposure model for Russia, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 19.2 million buildings, USD 4.2 trillion in replacement cost, and 144.0 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Russia | COM | 1.6 M |  | 0.4 T | 0.6 B | 0.4 B |
| Russia | IND | 0.9 M |  | 0.3 T | 0.4 B | 0.2 B |
| Russia | RES | 16.7 M | 144.0 M | 3.5 T | 5.8 B | 2.5 B |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_RUS.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | Russia in Numbers 2019<br>Russian Census 2010 | Federal State Statistics Service (Rosstat) | 2019 | 2025.0 | 1 | Residence type<br>Wall materials<br>Average apartment areas<br>Average construction cost |  | https://rosstat.gov.ru/ | Wall material data was taken from the 2010 Census, whereas more recent statistics spanning different years (e.g., 2019, 2020, 2021) were available online |
| IND, COM | Russia in Numbers 2019 | Federal State Statistics Service (Rosstat) | 2019 | 2025.0 | 1 | Average annual employment by economic activities<br>Number of organizations by economic activities<br>Number of active enterprises |  | https://rosstat.gov.ru/ | Admin level 1 in this case referring to economic regions |
| OCCUPANTS | Russia in Numbers 2019<br>Russian Census 2010 | Federal State Statistics Service (Rosstat) | 2019 | 2025.0 | 1 |  |  | https://rosstat.gov.ru/ |  |
