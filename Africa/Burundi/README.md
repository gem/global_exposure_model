# 🇧🇮 Burundi Exposure Model

This page provides an overview of the exposure model for Burundi, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 2.9 million buildings, USD 17.6 billion in replacement cost, and 14.4 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Burundi | COM | 0.0 M |  | 0.6 B | 4.3 M | 0.6 M |
| Burundi | IND | 0.0 M |  | 0.7 B | 2.0 M | 0.9 M |
| Burundi | RES | 2.9 M | 14.4 M | 16.3 B | 229.9 M | 24.8 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_BDI.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | Population and Housing Census, 2008 |  | 2008 | 2025.0 | 1 | Wall materials |  |  | Population based on United Nations World Population Prospects (rev 2019) and WorldPop (2020) at Adm1 |
