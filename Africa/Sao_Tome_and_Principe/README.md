# 🇸🇹 Sao_Tome_and_Principe Exposure Model

This page provides an overview of the exposure model for Sao_Tome_and_Principe, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 58.5 thousand buildings, USD 1.8 billion in replacement cost, and 240.3 thousand occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| São Tomé and Príncipe | COM | 1.1 K |  | 0.1 B | 0.2 M | 0.1 M |
| São Tomé and Príncipe | IND | 0.3 K |  | 0.0 B | 0.1 M | 0.0 M |
| São Tomé and Príncipe | RES | 57.1 K | 240.3 K | 1.7 B | 4.6 M | 1.0 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_STP.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
| IND, COM | Company Activities, 2010-14 |  | 2014 | 2025.0 | 0 |  |  |  | While available nonresidential data was investigated for Africa, International Labour Organization (ILO) for 2019 was used |
| OCCUPANTS | World Population Prospects 2020 |  | 2020 | 2025.0 | 1 |  |  |  |  |
| BOUNDARIES | OSM | OSM | 2025 |  | 1 | Administrative divisions at level 1 | ODbL | https://osm-boundaries.com/about/documentation#downloading-the-data | Models were adapted to the target boundary divisions. |
