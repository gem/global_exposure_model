# 🇸🇱 Sierra_Leone Exposure Model

This page provides an overview of the exposure model for Sierra_Leone, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 1.6 million buildings, USD 23.7 billion in replacement cost, and 8.8 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Sierra Leone | COM | 0.1 M |  | 3.0 B | 12.0 M | 4.7 M |
| Sierra Leone | IND | 0.0 M |  | 1.1 B | 3.2 M | 1.9 M |
| Sierra Leone | RES | 1.5 M | 8.8 M | 19.6 B | 118.4 M | 31.1 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_SLE.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | Integrated Household Survey, 2011 |  | 2011 | 2025.0 | 1 | Wall materials |  |  | Population based on United Nations World Population Prospects (rev 2019) and WorldPop (2020) at Adm1 |
| IND, COM | Labour Force Survey Report, 2014 |  | 2014 | 2025.0 | 0 |  |  |  | While available nonresidential data was investigated for Africa, International Labour Organization (ILO) for 2019 was used |
| OCCUPANTS | World Population Prospects 2020 |  | 2020 | 2025.0 | 1 |  |  |  |  |
| BOUNDARIES | World Bank | World Bank | 2025 |  | 1 | Administrative divisions at level 1 | CC BY 4.0 | https://datacatalog.worldbank.org/search/dataset/0038272/world-bank-official-boundaries | Admin 1 GPKG was taken directly from the target source without modification. Compared to the previous pre-standardization version, this version divides Northern Province into Northern and North Western. |
