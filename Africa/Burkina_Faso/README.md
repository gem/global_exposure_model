# 🇧🇫 Burkina_Faso Exposure Model

This page provides an overview of the exposure model for Burkina_Faso, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 4.4 million buildings, USD 58.0 billion in replacement cost, and 24.1 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Burkina Faso | COM | 0.2 M |  | 7.5 B | 28.7 M | 7.8 M |
| Burkina Faso | IND | 0.1 M |  | 7.6 B | 20.2 M | 12.9 M |
| Burkina Faso | RES | 4.1 M | 24.1 M | 42.9 B | 302.8 M | 57.3 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_BFA.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | Analysis of Living Conditions, 2007 |  | 2007 | 2025.0 | 1 | Wall materials |  |  |  |
| IND, COM | Analysis of the results of the annual survey on household living conditions and poverty monitoring in Burkina Faso, EAQUIB, 2007 |  | 2007 | 2025.0 | 0 |  |  |  | While available nonresidential data was investigated for Africa, International Labour Organization (ILO) for 2019 was used |
...
| BOUNDARIES | Institut Geographique Burkina (IGB) | OCHA Field Information Services Section (FISS) | 2025 |  | 1 | Administrative divisions at level 1 | CC BY-IGO 3.0 | https://www.geoboundaries.org/ | Models were adapted to the target source boundary file, no manual changes were made |
