# 🇨🇬 Congo Exposure Model

This page provides an overview of the exposure model for Congo, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 1.8 million buildings, USD 34.7 billion in replacement cost, and 6.5 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Congo | COM | 0.1 M |  | 2.9 B | 9.7 M | 3.6 M |
| Congo | IND | 0.0 M |  | 3.1 B | 6.5 M | 3.6 M |
| Congo | RES | 1.7 M | 6.5 M | 28.7 B | 140.9 M | 30.3 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_COG.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
| BOUNDARIES | World Bank | World Bank | 2025 |  | 1 | Administrative divisions at level 1 | CC BY 4.0 | https://datacatalog.worldbank.org/search/dataset/0038272/world-bank-official-boundaries | At the time of the 2026 standardization, Congo shows three additional administrative divisions that are not present in the target boundary. However, these extra divisions correspond to natural regions, river basins, or ecological areas rather than administrative units. |
