# 🇿🇦 South_Africa Exposure Model

This page provides an overview of the exposure model for South_Africa, including national totals, predominant building classes, and subnational distribution.
...
|---|---|---|---|---|---|---|
| South Africa | COM | 0.8 M |  | 114.5 B | 0.2 B | 100.3 M |
| South Africa | IND | 0.3 M |  | 54.3 B | 0.1 B | 46.3 M |
| South Africa | RES | 19.0 M | 64.7 M | 732.9 B | 1.6 B | 703.6 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_ZAF.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | General Household Survey, 2019 |  | 2019 | 2025.0 | 1 | Wall materials |  |  | Population based on United Nations World Population Prospects (rev 2019) and WorldPop (2020) at Adm1 |
| IND, COM | Quarterly Labour Force Survey, 2019 |  | 2019 | 2025.0 | 0 |  |  |  | While available nonresidential data was investigated for Africa, International Labour Organization (ILO) for 2019 was used |
