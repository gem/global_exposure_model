# 🇨🇫 Central_African_Republic Exposure Model

This page provides an overview of the exposure model for Central_African_Republic, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 1.1 million buildings, USD 16.0 billion in replacement cost, and 5.5 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Central African Republic | COM | 0.0 M |  | 1.0 B | 3.6 M | 1.0 M |
| Central African Republic | IND | 0.0 M |  | 0.6 B | 1.3 M | 0.7 M |
| Central African Republic | RES | 1.1 M | 5.5 M | 14.5 B | 87.5 M | 16.2 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_CAF.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES |  |  | 2020 | 2025.0 | 1 |  |  |  | Population based on United Nations World Population Prospects (rev 2019) and WorldPop (2020) at Adm1 |
...
| OCCUPANTS | World Population Prospects 2020 |  | 2020 | 2025.0 | 1 |  |  |  |  |
| BOUNDARIES | Institut Centrafricain des Statistiques et des Etudes Economiques et Sociales (ICASEES) | OCHA Field Information Services Section (FISS) | 2025 |  | 1 | Administrative divisions at level 1 | CC BY-IGO 3.0 | https://data.humdata.org/dataset/cod-ab-caf | If the dataset is shared or made public, users must include the following disclaime:<br>"The boundaries, names, and designations used on this map do not imply official endorsement or acceptance by the United Nations or the Central African government and are used for humanitarian planning purposes only." |
