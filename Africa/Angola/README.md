# 🇦🇴 Angola Exposure Model

This page provides an overview of the exposure model for Angola, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 9.3 million buildings, USD 216.7 billion in replacement cost, and 39.0 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Angola | COM | 0.4 M |  | 42.1 B | 85.6 M | 42.3 M |
| Angola | IND | 0.1 M |  | 11.8 B | 21.8 M | 12.3 M |
| Angola | RES | 8.8 M | 39.0 M | 162.8 B | 710.8 M | 223.1 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_AGO.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | Population and Housing Census, 2014 |  | 2014 | 2025.0 | 1 |  |  |  |  |
| IND, COM |  |  | 2019 | 2025.0 | 0 |  |  |  | While available nonresidential data was investigated for Africa, International Labour Organization (ILO) for 2019 was used |
| OCCUPANTS | World Population Prospects 2020 | UN | 2020 | 2025.0 | 1 |  |  |  | Population based on United Nations World Population Prospects (rev 2019) and WorldPop (2020) at Adm1 |
| BOUNDARIES | GAUL | GAUL | 2025 |  | 1 | Administrative divisions at level 1 | CC BY 4.0 | https://data.apps.fao.org/catalog/iso/34f97afc-6218-459a-971d-5af1162d318a | Base GPKG derived from GAUL. Administrative boundaries were edited to reflect the three new provinces implemented in 2025: Icolo e Bengo (separated from Luanda), Cuando (from the former Cuando Cubango), and Moxico Leste (separated from Moxico). Cubango also results from the division of the former Cuando Cubango province. The license allows modification of the GPKG. |
