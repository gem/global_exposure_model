# 🇲🇺 Mauritius Exposure Model

This page provides an overview of the exposure model for Mauritius, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 354.8 thousand buildings, USD 15.6 billion in replacement cost, and 1.3 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Mauritius | COM | 12.7 K |  | 1.6 B | 2.6 M | 1.5 M |
| Mauritius | IND | 5.3 K |  | 0.9 B | 1.5 M | 0.8 M |
| Mauritius | RES | 336.8 K | 1.3 M | 13.1 B | 28.3 M | 11.9 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_MUS.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | Population and Housing Census, 2013 |  | 2013 | 2025.0 | 1 | Wall materials |  |  | Population based on United Nations World Population Prospects (rev 2019) and WorldPop (2020) at Adm1 |
| IND, COM | Labour force, employment, and underemployment, 2016/Q1 |  | 2016 | 2025.0 | 0 |  |  |  | While available nonresidential data was investigated for Africa, International Labour Organization (ILO) for 2019 was used |
| OCCUPANTS | World Population Prospects 2020 |  | 2020 | 2025.0 | 1 |  |  |  |  |
| BOUNDARIES | GeoBoundaries | GeoBoundaries | 2025 |  | 1 | Administrative divisions at level 1 | CC BY 4.0 | https://www.geoboundaries.org/countryDownloads.html | Admin 1 GPKG was taken directly from the target source without modification. Compared to the previous pre-standardization version, additional features appear for Agalega Islands and Cargados Carajos Shoals. |
