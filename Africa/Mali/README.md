...
This page provides an overview of the exposure model for Mali, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 4.2 million buildings, USD 52.2 billion in replacement cost, and 25.2 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Mali | COM | 0.1 M |  | 3.4 B | 15.0 M | 3.4 M |
| Mali | IND | 0.0 M |  | 1.9 B | 5.2 M | 2.6 M |
| Mali | RES | 4.1 M | 25.2 M | 46.9 B | 330.4 M | 54.0 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_MLI.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
| IND, COM | Regional Integrated Survey on Employment and the Informal Sector, 2019 |  | 2019 | 2025.0 | 0 |  |  |  | While available nonresidential data was investigated for Africa, International Labour Organization (ILO) for 2019 was used |
| OCCUPANTS | World Population Prospects 2020 |  | 2020 | 2025.0 | 1 |  |  |  |  |
| BOUNDARIES | Mali Institut Géographique (IGM) | OCHA Field Information Services Section (FISS) | 2025 |  | 1 | Administrative divisions at level 1 | CC BY-IGO 3.0 | https://data.humdata.org/dataset/cod-ab-mli | Models were adapted to the target source boundary file, no manual changes were made |
