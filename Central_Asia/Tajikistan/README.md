# 🇹🇯 Tajikistan Exposure Model

This page provides an overview of the exposure model for Tajikistan, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 1.5 million buildings, USD 41.0 billion in replacement cost, and 10.5 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Tajikistan | COM | 0.1 M |  | 4.9 B | 11.4 M | 6.4 M |
| Tajikistan | IND | 0.0 M |  | 2.6 B | 4.6 M | 2.6 M |
| Tajikistan | RES | 1.4 M | 10.5 M | 33.5 B | 133.2 M | 47.0 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_TJK.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | Official statistics | TAJSTAT | 2020 | 2025.0 | 1 | Buildings, dwellings, total area sqm, occupants |  | https://www.stat.tj/en/population-and-housing-census/ | Model projected to 2025 using pop growth rates. Population distribution used as proxy to downscale model at Adm2 (requirement for CAREC II). |
| OCCUPANTS | Official statistics | TAJSTAT | 2020 | 2025.0 | 1 |  |  |  | Population was projected to the 2025 value indicated in https://www.stat.tj/en/. Population distribution used as proxy to downscale model at Adm2 (requirement for CAREC II). |
| IND, COM | Monthly list of employees by sectors 2011-2024, <br>Report on resuts of Economic Census of the Republic of Tajikistan 2010 | Agency on statistics under the President of the Republic of Tajikistan | 2024, <br>2010 | 2025.0 | 0 | Number of employees per economical activity (2024),<br>Average number of employees per entity based on the economical activity |  | https://www.stat.tj/en/analytical-tables/ | To obtain the updated  number of entities aprox, the average number of employees per entity per economical activity presented un the report (Tables 4 and 15). Population distribution used as proxy to downscale model at Adm2 (requirement for CAREC II). |
