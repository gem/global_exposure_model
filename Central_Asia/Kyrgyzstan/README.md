# 🇰🇬 Kyrgyzstan Exposure Model

This page provides an overview of the exposure model for Kyrgyzstan, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 943.4 thousand buildings, USD 52.3 billion in replacement cost, and 7.3 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Kyrgyzstan | COM | 78.5 K |  | 13.8 B | 29.6 M | 17.8 M |
| Kyrgyzstan | IND | 21.3 K |  | 1.1 B | 1.9 M | 1.1 M |
| Kyrgyzstan | RES | 843.6 K | 7.3 M | 37.5 B | 128.2 M | 41.7 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_KGZ.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | Housing Census | National Statistical Committee of the Kyrgyz Republic | 2022 | 2025.0 | 1 | Dwellings by territory; Total living space per 1 people |  | https://stat.gov.kg/en/statistics/naselenie/ | Model projected to 2025 using pop growth rates. Population distribution used as proxy to downscale model at Adm2 (requirement for CAREC II). |
| IND, COM | Number of active business entities in the Kyrgyz Republic by types of economic activity (2014-2025), Employed population by type of economic activity and territory | National Statistical Committee of the Kyrgyz Republic | 2025, 2023 | 2025.0 | 1 | Number of entities per size, territory, economical activity<br>,Number of employees by type of economic activity and territory |  | https://stat.gov.kg/, <br>http://stat.kg/en/statistics/zanyatost/ | Population distribution used as proxy to downscale model at Adm2 (requirement for CAREC II). |
| OCCUPANTS | Resident population of regions, districts, cities, aiyl aimaks and aiyls (villages) of the Kyrgyz Republic (2025) | National Statistical Committee of the Kyrgyz Republic | 2025 | 2025.0 | 1 |  |  | https://stat.gov.kg/en/statistics/naselenie/ | Model projected to 2025 using pop growth rates. Population distribution used as proxy to downscale model at Adm2 (requirement for CAREC II). |
| BOUNDARIES | OSM | OSM | 2025 |  | 1 | Administrative divisions at level 1 | ODbL | https://osm-boundaries.com/about/documentation#downloading-the-data |  |
