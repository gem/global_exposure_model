# 🇹🇲 Turkmenistan Exposure Model

This page provides an overview of the exposure model for Turkmenistan, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 675.7 thousand buildings, USD 46.5 billion in replacement cost, and 7.6 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Turkmenistan | COM | 59.9 K |  | 6.9 B | 10.2 M | 6.5 M |
| Turkmenistan | IND | 7.4 K |  | 0.7 B | 1.2 M | 0.7 M |
| Turkmenistan | RES | 608.4 K | 7.6 M | 38.8 B | 104.2 M | 48.5 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_TKM.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | Key Indicators for Asia and the Pacific | Asian Development Bank (ADB) | 2020 | 2025.0 | 1 | Population |  | https://www.adb.org/publications/key-indicators-asia-and-pacific-2020#accordion-3-1 |  |
| IND, COM | Key Indicators for Asia and the Pacific | Asian Development Bank (ADB) | 2020 | 2025.0 | 1 | Labour force by economic activity |  | https://www.adb.org/publications/key-indicators-asia-and-pacific-2020#accordion-3-1 |  |
| OCCUPANTS | Key Indicators for Asia and the Pacific | Asian Development Bank (ADB) | 2020 | 2025.0 | 1 |  |  |  | Even though the model is for 2020, when compared with WB data, the population represents values from 2014. |
| BOUNDARIES | GeoBoundaries | GeoBoundaries | 2025 |  | 1 | Administrative divisions at level 1 | CC BY 4.0 | https://www.geoboundaries.org/countryDownloads.html | In the Geoboundaries shapefile the area of Aşgabat was removed and included in Ahal, the city of Aşgabat was manually included again to maintain the detail in the exposure models for that area |
