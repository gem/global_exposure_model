# 🇮🇩 Indonesia Exposure Model

This page provides an overview of the exposure model for Indonesia, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 47.3 million buildings, USD 2.1 trillion in replacement cost, and 285.7 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Indonesia | COM | 4.9 M |  | 0.3 T | 0.5 B | 0.3 B |
| Indonesia | IND | 0.9 M |  | 0.1 T | 0.2 B | 0.1 B |
| Indonesia | RES | 41.5 M | 285.7 M | 1.7 T | 4.7 B | 1.8 B |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_IDN.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | Population Census | Statistics of Indonesia | 2020 | 2025.0 | 2 |  |  |  | https://gitlab.openquake.org/risk/global_risk_model/Exposure/-/merge_requests/100 |
| COM, IND | Economic Census | Statistics of Indonesia | 2016 | 2025.0 | 2 | Economic Activity; Business Scale |  | http://www.stat.go.jp/english/info/meetings/cambodia/e11f_re1.htm; http://nada-nis.gov.kh/index.php/catalog/21; https://www.nis.gov.kh/nis/EC2011/EC2011_Final_Results_Revised.pdf | Report available for each province; Crossed-var at Province level; Non-crossed at Regency level |
| OCCUPANTS | Population Census | Statistics of Indonesia | 2020 | 2025.0 | 2 |  |  |  |  |
| BOUNDARIES | World Bank | World Bank | 2025 |  | 1 | Administrative divisions at level 1 | CC BY 4.0 | https://datacatalog.worldbank.org/search/dataset/0038272/world-bank-official-boundaries | Boundaries changed, the modells were adapted to be consistento to the target source adm1 boundaries |
