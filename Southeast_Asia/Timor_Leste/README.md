# 🇹🇱 Timor_Leste Exposure Model

This page provides an overview of the exposure model for Timor_Leste, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 257.1 thousand buildings, USD 11.6 billion in replacement cost, and 1.4 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Timor-Leste | COM | 16.3 K |  | 2.5 B | 3.7 M | 2.2 M |
| Timor-Leste | IND | 5.7 K |  | 0.9 B | 1.2 M | 0.7 M |
| Timor-Leste | RES | 235.1 K | 1.4 M | 8.3 B | 23.6 M | 7.6 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_TLS.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | 2015 Population and Housing Census | Government of Timor-Leste | 2015 | 2025.0 | 3 | Wall material; Number of Households |  |  |  |
| COM, IND | 2015 Population and Housing Census | Government of Timor-Leste | 2015 | 2025.0 | 2 | % of employed population by industry and administrative region |  |  |  |
| OCCUPANTS | 2015 Population and Housing Census | Government of Timor-Leste | 2015 | 2025.0 | 3 |  |  |  |  |
| BOUNDARIES | OSM | OSM | 2025 |  | 1 | Administrative divisions at level 1 | ODbL | https://osm-boundaries.com/about/documentation#downloading-the-data | ADM1 boundaries remain practically unchanged, except that in the previous version the territory of Ataúru Island was not separated as an independent division. |
