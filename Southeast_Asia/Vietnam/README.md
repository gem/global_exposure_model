# 🇻🇳 Vietnam Exposure Model

This page provides an overview of the exposure model for Vietnam, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 27.6 million buildings, USD 579.2 billion in replacement cost, and 101.6 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Vietnam | COM | 1.4 M |  | 100.2 B | 0.2 B | 121.9 M |
| Vietnam | IND | 0.1 M |  | 4.4 B | 0.0 B | 6.4 M |
| Vietnam | RES | 26.1 M | 101.6 M | 474.6 B | 2.1 B | 913.9 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_VNM.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | Population and Housing Census | General Statistics Office | 2009 | 2025.0 | 1 | Year of construction; Type of housing; Type of area |  | http://web.nso.go.th/en/census/poph/cen_poph.htm; http://popcensus.nso.go.th/en/report.php | Bdg counts were fixed in 2022 realase (matching WIP repo) |
| COM, IND | Survey of non-Farm individual business establishments | General Statistics Office | 2015 | 2025.0 | 1 | Type of economic activities (Not very useful) |  | http://www.gso.gov.vn/default_en.aspx?tabid=515&idmid=5&ItemID=16063 | Tables extracted from pdf (2017 census); 2021 data not released yet; Other information available: Survey of non-Farm individual business establishments |
| OCCUPANTS | Population and Housing Census | General Statistics Office | 2009 | 2025.0 | 1 |  |  | http://web.nso.go.th/en/census/poph/cen_poph.htm; http://popcensus.nso.go.th/en/report.php |  |
| BOUNDARIES | General Statistics Office of Vietnam (GSO) | United Nations Office for the Coordination of Humanitarian Affairs (OCHA) | 2025 |  | 1 | Administrative divisions at level 1 | CC BY-IGO 3.0 | https://data.humdata.org/dataset/cod-ab-phl? | Administrative boundaries changed, models were adapted to match the boundaries' target source |
