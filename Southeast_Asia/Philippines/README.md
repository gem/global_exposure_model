# 🇵🇭 Philippines Exposure Model

This page provides an overview of the exposure model for Philippines, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 27.8 million buildings, USD 527.8 billion in replacement cost, and 116.7 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Philippines | COM | 0.7 M |  | 30.6 B | 0.1 B | 34.0 M |
| Philippines | IND | 0.2 M |  | 7.4 B | 0.0 B | 9.0 M |
| Philippines | RES | 26.9 M | 116.7 M | 489.9 B | 1.4 B | 537.1 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_PHL.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | Census of Population and Housing | Philippine Statistics Authority | 2020 | 2025.0 | 4 | Construction material of the outer walls; Construction material of roof; Construction material of floor ;Rura/Urban; Number of stories;Date  of construction; Type of building/house; State of repair of the building/house; Floor area of the housing unit |  | https://psada.psa.gov.ph/catalog/231<br><br>https://psada.psa.gov.ph//catalog/231/get-microdata | To get access to the microdata at adm level 4, a form to request information must be sen to Philippine Statitics Authority (waiting usually 1 week)<br><br>Census also available for 2015; Crossed variables found at regional level 3<br><br>Census also available for 2010; Crossed variables found at regional level 2: http://calabarzon.neda.gov.ph/wp-content/uploads/2016/03/RSET2015-Ch.1-PopulationAndHousing.xlsx |
| COM, IND | Number of Establishments by Region, Section and Employment Groupings | Philippine Statistics Authority | 2023 | 2025.0 | 1 | Type of economic activities; Number of employees, enterprice size |  | https://rssocar.psa.gov.ph/establishment/node/1684058491 | For the values detailed per activity, size and adm region  a form to request information must be sen to Philippine Statitics Authority (waiting usually 1 week) |
| BOUNDARIES | Philippines Statistics Authority, National Mapping and Resource Information Authority (NAMRIA) | United Nations Office for the Coordination of Humanitarian Affairs (OCHA) | 2020 |  | 4 | ID and Areas related to census | CC BY-IGO 3.0 | https://data.humdata.org/dataset/cod-ab-phl? | Negros Island administrative region was manually separated to standardize ADM1 in GEM.<br>Only numeric codes for Manila were manually adjusted to match census' codes, the other ones in the country matched with census data.<br><br>For Ormoc city located in Region VIII (Eastern Visayas) the division for ADM level 4 were made manually, since the cenus considered the division before the plebicite, see https://www.rappler.com/philippines/visayas/things-to-know-ormoc-city-october-8-plebiscite/ |
| COSTS RES | Bangko Sentral ng Pilipinas (BSP) | Residential real estate price index | 2024 | 2025.0 | - | Cots residential |  | bsp.gov.ph/Media_And_Research/Media Releases/2024_09/news-09272024a1.aspx |  |
| COSTS IND,COM | Philippines Statistics Authority | Construction Statistics from Approved Building Permits | 2024 | 2025.0 | - | Cost com and ind |  | https://psa.gov.ph/content/construction-statistics-approved-building-permits-september-2024 |  |
| OCCUPANTS | Population Projection Statistics | Philippine Statistics Authority | 2024 | 2025.0 | 4 | Population |  | https://psa.gov.ph/statistics/census/projected-population | Proyections until 2055, every 5 years (Pop only, Release Date: Wednesday, January 31, 2024) |
