# 🇲🇾 Malaysia Exposure Model

This page provides an overview of the exposure model for Malaysia, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 8.3 million buildings, USD 468.4 billion in replacement cost, and 36.0 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Malaysia | COM | 0.6 M |  | 44.3 B | 0.1 B | 45.7 M |
| Malaysia | IND | 0.1 M |  | 18.7 B | 0.0 B | 19.4 M |
| Malaysia | RES | 7.6 M | 36.0 M | 405.3 B | 1.0 B | 410.4 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_MYS.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | Population and Housing Census | Department of Statistics Malaysia | 2010 | 2025.0 | 1 | Outer wall material; Type of housing unit; Type of area |  | https://www.dosm.gov.my/v1/index.php?r=column/cthree&menu_id=cEhBV0xzWll6WTRjdkJienhoR290QT09 | Table 5: Total housing units by construction material of outer walls, type of housing units, stratum and state, Malaysia, 2010, is available only by stratum and state |
| COM, IND | Economic Census | Department of Statistics Malaysia | 2016 | 2025.0 | 1 | Number of establishments by state/activity; Size of establishments (national level)/activity; (Wholesale is not reported) |  | https://www.lsb.gov.la/pdf/Final_report_Economic%20census_2006.pdf | Economic Census also available |
| OCCUPANTS | Population and Housing Census | Department of Statistics Malaysia | 2010 | 2025.0 | 1 |  |  |  |  |
