# 🇵🇾 Paraguay Exposure Model

This page provides an overview of the exposure model for Paraguay, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 941.7 thousand buildings, USD 59.2 billion in replacement cost, and 7.0 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Paraguay | COM | 67.8 K |  | 7.8 B | 13.0 M | 6.5 M |
| Paraguay | IND | 45.5 K |  | 6.4 B | 12.6 M | 5.7 M |
| Paraguay | RES | 828.4 K | 7.0 M | 45.0 B | 98.1 M | 39.4 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_PRY.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | GED4GEM | GEM Foundation | 2012 | 2025.0 | 1.0 |  |  |  |  |
...
| BOUNDARIES | GeoBoundaries | GeoBoundaries | 2025 |  | 1.0 | Administrative divisions at level 1 | CC BY 4.0 | https://www.geoboundaries.org/countryDownloads.html |  |
