# 🇨🇴 Colombia Exposure Model

This page provides an overview of the exposure model for Colombia, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 9.8 million buildings, USD 832.7 billion in replacement cost, and 53.1 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Colombia | COM | 0.4 M |  | 79.6 B | 0.1 B | 68.4 M |
| Colombia | IND | 0.3 M |  | 50.6 B | 0.1 B | 37.6 M |
| Colombia | RES | 9.1 M | 53.1 M | 702.5 B | 2.0 B | 803.0 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_COL.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | Population and Housing Census | Departamento Administrativo Nacional de Estadística | 2018 | 2025.0 | 4 | Population, dwellings, buildings, wall material, floor material, type of dwelling, economical strata |  | https://microdatos.dane.gov.co/index.php/catalog/643/get-microdata | Models were brought to 2025 by using the country's latest projections for adm level 2 |
...
| OCCUPANTS | Proyecciones de población y estudios demográficos (pped)-Periodo 2018-2042 | Departamento Administrativo Nacional de Estadística | 2025 | 2025.0 | 2 | Population for 2025 |  | https://www.dane.gov.co/index.php/estadisticas-por-tema/demografia-y-poblacion/proyecciones-de-poblacion |  |
| IND, COM | Directorio Estadístico de Empresas, DEE | Departamento Administrativo Nacional de Estadística | 2021 | 2025.0 | 2 | number of establishments, economical activity macro-micro |  | https://view.officeapps.live.com/op/view.aspx?src=https%3A%2F%2Fgeoportal.dane.gov.co%2Fdescargas%2Fdirectorio_Est%2FDatosAgregados_DEE.xlsx&wdOrigin=BROWSELINK |  |
