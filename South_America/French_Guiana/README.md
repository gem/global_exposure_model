# 🇬🇫 French_Guiana Exposure Model

This page provides an overview of the exposure model for French_Guiana, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 38.7 thousand buildings, USD 8.4 billion in replacement cost, and 313.6 thousand occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| French Guiana | COM | 1.5 K |  | 0.8 B | 0.4 M | 0.2 M |
| French Guiana | IND | 1.0 K |  | 0.5 B | 0.3 M | 0.1 M |
| French Guiana | RES | 36.2 K | 313.6 K | 7.1 B | 4.9 M | 1.8 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_GUF.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | GED4GEM | GEM Foundation | 2012 | 2025.0 | 1.0 |  |  |  | Perhaps the source data comes from the French model in ESRM2020 |
| IND, COM | GED4GEM | GEM Foundation | 2012 | 2025.0 | 1.0 |  |  |  |  |
| OCCUPANTS | WorldPop |  | 2021 | 2025.0 |  |  |  |  | Counts projected to 2021 using distributed pop from 2020 WorldPop |
| BOUNDARIES | OSM | OSM | 2025 |  | 1.0 | Administrative divisions at level 1 | ODbL | https://osm-boundaries.com/about/documentation#downloading-the-data | tha adm1 boundaries changed therefore the models were adapted to follow the target source boundaries |
