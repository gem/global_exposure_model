# 🇸🇷 Suriname Exposure Model

This page provides an overview of the exposure model for Suriname, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 54.8 thousand buildings, USD 2.5 billion in replacement cost, and 639.9 thousand occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Suriname | COM | 2.9 K |  | 0.3 B | 0.6 M | 0.3 M |
| Suriname | IND | 2.2 K |  | 0.3 B | 0.5 M | 0.2 M |
| Suriname | RES | 49.6 K | 639.9 K | 1.9 B | 4.6 M | 1.8 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_SUR.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | GED4GEM | GEM Foundation | 2012 | 2025.0 | 1 |  |  |  | The projections by 2021 reduced the number f buildings. 2022 census indicates +17M dwellings |
| IND, COM | GED4GEM | GEM Foundation | 2012 | 2025.0 | 1 |  |  |  | Counts projected to 2019 using GDP growth per sector according to WDI |
| OCCUPANTS |  |  | 2021 | 2025.0 | 1 |  |  |  | Counts projected to 2021 using distributed pop from 2020 WorldPop |
