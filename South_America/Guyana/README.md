# 🇬🇾 Guyana Exposure Model

This page provides an overview of the exposure model for Guyana, including national totals, predominant building classes, and subnational distribution.
...
|---|---|---|---|---|---|---|
| Guyana | COM | 8.0 K |  | 1.3 B | 1.2 M | 0.6 M |
| Guyana | IND | 6.1 K |  | 1.1 B | 1.4 M | 0.6 M |
| Guyana | RES | 149.0 K | 836.0 K | 4.9 B | 12.4 M | 2.0 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_GUY.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | GED4GEM | GEM Foundation | 2012 | 2025.0 | 1 |  |  |  | Counts projected to 2021 using distributed pop from 2020 WorldPop |
| IND, COM | GED4GEM | GEM Foundation | 2012 | 2025.0 | 1 |  |  |  | Counts projected to 2019 using GDP growth per sector according to WDI |
| OCCUPANTS | WorldPop |  | 2021 | 2025.0 | 1 |  |  |  | Counts projected to 2021 using distributed pop from 2020 WorldPop |
