# 🇪🇨 Ecuador Exposure Model

This page provides an overview of the exposure model for Ecuador, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 4.0 million buildings, USD 459.1 billion in replacement cost, and 16.9 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Ecuador | COM | 0.4 M |  | 80.1 B | 102.9 M | 51.0 M |
| Ecuador | IND | 0.2 M |  | 20.8 B | 27.4 M | 12.5 M |
| Ecuador | RES | 3.5 M | 16.9 M | 358.2 B | 544.2 M | 213.6 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_ECU.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | Population and Housing Census | Instituto Nacional de Estadística y Censos | 2022 | 2025.0 | 4 | Population, dwellings, wall material, floor material, type of dwelling |  | https://www.censoecuador.gob.ec/resultados-censo/ | Models were brought to 2025 by using the country's latest projections for adm level 2 |
| IND, COM | Censo Nacional Economico | Instituto Nacional de Estadística y Censos | 2023 | 2025.0 | 2 | Number of establishments, economical activity macro-micro |  | https://www.ecuadorencifras.gob.ec/directoriodeempresas/ |  |
| OCCUPANTS | Población estimada por edades simples y grupos de edad, según departamento, provincia y distrito. 2025 | Instituto Nacional de Estadística y Censos | 2025 | 2025.0 | 2 |  |  | https://www.ecuadorencifras.gob.ec/proyecciones-poblacionales/ | In the most recent data, 5 administrative divisions changed their codes/regions compared to the 2025 census data, as follows: AREA #070750019 ? AREA #070750999, AREA #080650910 ? AREA #080650999, AREA #090450009 ? AREA #090450999, AREA #130851910 ? AREA #130851999, AREA #220154909 ? AREA #220154999 |
| BOUNDARIES | Datos espaciales INEI | Instituto Nacional de Estadística y Censos (INEC) | 2022 |  | 1,4 | Administrative divisions from level 1 to 4 | https://www.ecuadorencifras.gob.ec/documentos/web-inec/Geografia_Estadistica/Micrositio_geoportal/assets/acuerdousopoliticasmgn.pdf | https://www.ecuadorencifras.gob.ec/documentos/web-inec/Geografia_Estadistica/Micrositio_geoportal/index.html | The layers for the other administrative levels are also available. |
