# 🇧🇴 Bolivia Exposure Model

This page provides an overview of the exposure model for Bolivia, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 3.5 million buildings, USD 101.6 billion in replacement cost, and 12.6 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Bolivia | COM | 0.1 M |  | 15.4 B | 30.0 M | 15.6 M |
| Bolivia | IND | 0.0 M |  | 2.6 B | 4.7 M | 2.2 M |
| Bolivia | RES | 3.4 M | 12.6 M | 83.6 B | 261.6 M | 71.2 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_BOL.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | Population and Housing Census | Instituto Nacional de Estadística | 2012 | 2025.0 | 3.0 |  |  |  | Counts projected to 2021 using distributed pop from 2020 WorldPop |
| IND, COM | Censo agropecuario 2012 | Instituto Nacional de Estadística | 2012 | 2025.0 | 1.0 |  |  |  | Counts projected to 2019 using GDP growth per sector according to WDI |
