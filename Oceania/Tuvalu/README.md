# 🇹🇻 Tuvalu Exposure Model

This page provides an overview of the exposure model for Tuvalu, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 2.9 thousand buildings, USD 321.2 million in replacement cost, and 9.5 thousand occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Tuvalu | COM | 0.2 K |  | 51.0 M | 24.9 K | 12.4 K |
| Tuvalu | IND | 0.0 K |  | 1.4 M | 1.4 K | 0.6 K |
| Tuvalu | RES | 2.7 K | 9.5 K | 268.8 M | 210.0 K | 87.8 K |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_TUV.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | Tuvalu 2022 Census on Population and Housing Analytical Report | Pacific Community (SPC) and Central Statistics Division (CSD) | 2022 | 2025.0 | 1 | Number of households by Island; Percentage distribution of material for main house construction |  | https://stats.gov.tv/census/ |  |
| IND, COM | Tuvalu 2022 Census on Population and Housing Analytical Report | Pacific Community (SPC) and Central Statistics Division (CSD) | 2022 | 2025.0 | 0 | Percentage of residents aged 15 and over by type of industry |  | https://stats.gov.tv/census/ |  |
| OCCUPANTS | Tuvalu 2022 Census on Population and Housing Analytical Report | Pacific Community (SPC) and Central Statistics Division (CSD) | 2022 | 2025.0 | 1 | Resident population by home island |  | https://stats.gov.tv/census/ |  |
| BOUNDARIES | GAUL | GAUL | 2024 |  | 1 | Administrative divisions at level 1 | CC BY 4.0 | https://data.apps.fao.org/catalog/iso/34f97afc-6218-459a-971d-5af1162d318a |  |
