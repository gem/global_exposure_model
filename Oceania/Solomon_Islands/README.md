# 🇸🇧 Solomon_Islands Exposure Model

This page provides an overview of the exposure model for Solomon_Islands, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 175.7 thousand buildings, USD 18.6 billion in replacement cost, and 838.6 thousand occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Solomon Islands | COM | 9.7 K |  | 4.2 B | 3.0 M | 0.6 M |
| Solomon Islands | IND | 2.1 K |  | 1.7 B | 1.3 M | 0.3 M |
| Solomon Islands | RES | 163.9 K | 838.6 K | 12.8 B | 17.8 M | 2.2 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_SLB.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|
| RES | 2019 Population and Housing Census National Report (Volume 1) | Solomon Islands National Statistics Office | 2019 | 2025.0 | 1 | Number of private households and main wall material used for dwellings by province |  | https://statistics.gov.sb/documents/#all_0-60-solomon-islands-2019-population-and-housing-census-national-report_volume-1-and-2 |
| IND, COM | National Economic Establishment Census 2024 | Solomon Islands National Statistics Office | 2024 | 2025.0 | 0 | Number of Formal and Informal Establishments in Selected Industries |  | https://statistics.gov.sb/documents/#all_0-25-national-account |
| OCCUPANTS | 2019 Population and Housing Census Basic Tables and Census Description (Volume 2) | Solomon Islands National Statistics Office | 2019 | 2025.0 | 1 | Total population by census year and province |  | https://statistics.gov.sb/documents/#all_0-60-solomon-islands-2019-population-and-housing-census-national-report_volume-1-and-2 |
