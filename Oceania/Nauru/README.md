# 🇳🇷 Nauru Exposure Model

This page provides an overview of the exposure model for Nauru, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 3.2 thousand buildings, USD 720.1 million in replacement cost, and 12.0 thousand occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Nauru | COM | 0.2 K |  | 124.8 M | 84.8 K | 38.6 K |
| Nauru | IND | 0.1 K |  | 59.5 M | 43.7 K | 19.5 K |
| Nauru | RES | 2.8 K | 12.0 K | 535.8 M | 414.9 K | 155.0 K |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_NRU.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|
| RES | Nauru 2021 Population and Housing Census - Household tabulations and Analytical Report | Pacific Community (SPC) and Government of the Republic of Nauru | 2021 | 2025.0 | 1 | Private Dwelling Household by District by Main Material of Wall; Number of households and average household size by district |  | https://stats.gov.nr/category/surveys/ |
| IND, COM | Nauru 2021 Population and Housing Census - Analytical Report | Pacific Community (SPC) and Government of the Republic of Nauru | 2021 | 2025.0 | 0 | Employed population by industry |  | https://stats.gov.nr/category/surveys/ |
| OCCUPANTS | Nauru 2021 Population and Housing Census - Analytical Report | Pacific Community (SPC) and Government of the Republic of Nauru | 2021 | 2025.0 | 1 | Population size by district |  | https://stats.gov.nr/category/surveys/ |
