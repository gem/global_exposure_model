# 🇹🇴 Tonga Exposure Model

This page provides an overview of the exposure model for Tonga, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 31.1 thousand buildings, USD 5.0 billion in replacement cost, and 103.7 thousand occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Tonga | COM | 3.9 K |  | 1.3 B | 1.2 M | 0.6 M |
| Tonga | IND | 0.3 K |  | 0.1 B | 0.1 M | 0.0 M |
| Tonga | RES | 26.9 K | 103.7 K | 3.7 B | 4.4 M | 1.4 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_TON.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|
| RES | Tonga 2021 Census of Population and Housing - Household tables | Tonga Statistics Department | 2021 | 2025.0 | 2 | Households construction material used for outside wall of main dwelling by district |  | https://tongastats.gov.to/census-2/population-census-3/census-report-and-factsheet/ |
| IND, COM | Tonga 2021 Census of Population and Housing - Volume 2: Analytical Report | Tonga Statistics Department | 2021 | 2025.0 | 0 | Total employment by Industry Group |  | https://tongastats.gov.to/census-2/population-census-3/census-report-and-factsheet/ |
| OCCUPANTS | Tonga 2021 Census of Population and Housing - Demography Tables | Tonga Statistics Department | 2021 | 2025.0 | 2 | Total Population by district |  | https://tongastats.gov.to/census-2/population-census-3/census-report-and-factsheet/ |
