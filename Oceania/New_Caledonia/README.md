# 🇳🇨 New_Caledonia Exposure Model

This page provides an overview of the exposure model for New_Caledonia, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 69.5 thousand buildings, USD 16.5 billion in replacement cost, and 295.3 thousand occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| New Caledonia | COM | 5.5 K |  | 2.1 B | 1.0 M | 0.5 M |
| New Caledonia | IND | 0.6 K |  | 0.2 B | 0.1 M | 0.0 M |
| New Caledonia | RES | 63.4 K | 295.3 K | 14.2 B | 7.4 M | 2.5 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_NCL.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|
| RES | 2014 National census | Institut de la statistique et des études économiques Nouvelle-Calédonie | 2014 | 2 | Wall material | https://www.isee.nc/population/recensement |  |  |
| IND, COM | 2014 National census | Institut de la statistique et des études économiques Nouvelle-Calédonie | 2014 | 2 | Active population per adm region per economic activity | https://www.isee.nc/population/recensement |  |  |
| OCCUPANTS | 2014 National census | Institut de la statistique et des études économiques Nouvelle-Calédonie | 2014 | 2 |  | https://www.isee.nc/population/recensement |  |  |
| BOUNDARIES | Gouvernement de la Nouvelle-Calédonie | Gouvernement de la Nouvelle-Calédonie | 2024 | 1 | Administrative divisions at level 1 | https://georep-dtsi-sgt.opendata.arcgis.com/maps/limites-administratives-terrestres-1/about | https://ia.numerique.gouv.fr/licence-ouverte-open-licence/ | The administrative divisions at level 1 match; there were no major changes |
