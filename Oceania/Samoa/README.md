# 🇼🇸 Samoa Exposure Model

This page provides an overview of the exposure model for Samoa, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 51.6 thousand buildings, USD 9.7 billion in replacement cost, and 219.3 thousand occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Samoa | COM | 5.8 K |  | 1.9 B | 1.7 M | 0.8 M |
| Samoa | IND | 0.3 K |  | 0.2 B | 0.1 M | 0.1 M |
| Samoa | RES | 45.5 K | 219.3 K | 7.6 B | 6.9 M | 2.1 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_WSM.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | Samoa Population and Housing Census Basic Tables | Samoa Bureau of Statistics | 2021 | 2025.0 | 2 | Total houses listed with main types of outer walls and place of residence |  | https://www.sbs.gov.ws/census/ |  |
| IND, COM | Samoa Population and Housing Census Basic Tables | Samoa Bureau of Statistics | 2021 | 2025.0 | 0 | Population 15 years and over by main industry |  | https://www.sbs.gov.ws/census/ |  |
| OCCUPANTS | Samoa Population and Housing Census Basic Tables | Samoa Bureau of Statistics | 2021 | 2025.0 | 2 | Total population by place of residence |  | https://www.sbs.gov.ws/census/ |  |
| BOUNDARIES | GeoBoundaries | GeoBoundaries | 2025 |  | 1 | Administrative divisions at level 1 | CC BY 4.0 | https://www.geoboundaries.org/countryDownloads.html | The administrative divisions at level 1 match; GeoBoundaries geometry better matches current administrative boundaries than the previous GAUL version, while maintaining the same number and names of divisions. |
