# 🇻🇺 Vanuatu Exposure Model

This page provides an overview of the exposure model for Vanuatu, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 81.0 thousand buildings, USD 8.2 billion in replacement cost, and 335.2 thousand occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Vanuatu | COM | 5.8 K |  | 2.7 B | 1.5 M | 0.6 M |
| Vanuatu | IND | 0.4 K |  | 0.2 B | 0.1 M | 0.0 M |
| Vanuatu | RES | 74.8 K | 335.2 K | 5.3 B | 7.0 M | 1.8 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_VUT.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|
| RES | 2020 National Population and Housing Census Basic Tables Report Volume 1 | Vanuatu Bureau of Statistics and the Pacific Community | 2020 | 2025.0 | 2 | Number of Private households by main material used for wall by region |  | https://vbos.gov.vu/index.php/en/census-and-surveys/census-report |
| IND, COM | 2020 National Population and Housing Census Analytical Report Volume 2 | Vanuatu Bureau of Statistics and the Pacific Community | 2020 | 2025.0 | 0 | Employed population by economic sector |  | https://vbos.gov.vu/index.php/en/census-and-surveys/census-report |
| OCCUPANTS | 2020 National Population and Housing Census Basic Tables Report Volume 1 | Vanuatu Bureau of Statistics and the Pacific Community | 2020 | 2025.0 | 2 | Total population by region |  | https://vbos.gov.vu/index.php/en/census-and-surveys/census-report |
