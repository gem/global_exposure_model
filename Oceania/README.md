...
# Oceania Exposure Model

## ✨ Overview

> The `v2026.0.0` release for the Oceania exposure model is now available! 🥳 🚀

This repository contains the latest exposure model files for the countries and territories in **Oceania**.
...
| COUNTRY | ISO3 |
|---------|------|
| [American_Samoa](American_Samoa/README.md) | ASM |
| [Australia](Australia/README.md) | AUS |
| [Cook_Islands](Cook_Islands/README.md) | COK |
| [Fiji](Fiji/README.md) | FJI |
| [Guam](Guam/README.md) | GUM |
| [Kiribati](Kiribati/README.md) | KIR |
| [Marshall_Islands](Marshall_Islands/README.md) | MHL |
| [Micronesia](Micronesia/README.md) | FSM |
| [Nauru](Nauru/README.md) | NRU |
| [New_Caledonia](New_Caledonia/README.md) | NCL |
| [New_Zealand](New_Zealand/README.md) | NZL |
| [Niue](Niue/README.md) | NIU |
| [Northern_Mariana_Islands](Northern_Mariana_Islands/README.md) | MNP |
| [Palau](Palau/README.md) | PLW |
| [Papua_New_Guinea](Papua_New_Guinea/README.md) | PNG |
| [Samoa](Samoa/README.md) | WSM |
| [Solomon_Islands](Solomon_Islands/README.md) | SLB |
| [Tonga](Tonga/README.md) | TON |
| [Tuvalu](Tuvalu/README.md) | TUV |
| [Vanuatu](Vanuatu/README.md) | VUT |
</details>

## 📊 Regional summary

The regional exposure includes the distribution of buildings, replacement value, and exposed population across all countries in **Oceania**. The regional exposure includes 15.5 million buildings, USD 9.8 trillion in replacement cost, and 45.8 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 5. See [Adm0 summary table](_region/Exposure_Oceania_Adm0.csv) for additional national level metrics.
...
_Table: Regional exposure model summary per country in Oceania. See [Adm0 summary table](_region/Exposure_Oceania_Adm0.csv) for the comple list of national level metrics._

| COUNTRY | BUILDINGS | OCCUPANTS | REPLACEMENT COST (USD) | BUILT-UP AREA (SQM) | EMBODIED CARBON (TON) |
|---|---|---|---|---|---|
| Australia | 9.6 M | 26.5 M | 8.2 T | 3.9 B | 1.1 B |
| Papua New Guinea | 2.6 M | 10.8 M | 0.1 T | 0.2 B | 0.0 B |
| New Zealand | 2.5 M | 5.3 M | 1.4 T | 0.6 B | 0.1 B |
| Fiji | 0.2 M | 0.9 M | 0.0 T | 0.0 B | 0.0 B |
| Solomon Islands | 0.2 M | 0.8 M | 0.0 T | 0.0 B | 0.0 B |
| Vanuatu | 0.1 M | 0.3 M | 0.0 T | 0.0 B | 0.0 B |
| New Caledonia | 0.1 M | 0.3 M | 0.0 T | 0.0 B | 0.0 B |
| Kiribati | 0.1 M | 0.1 M | 0.0 T | 0.0 B | 0.0 B |
| Samoa | 0.1 M | 0.2 M | 0.0 T | 0.0 B | 0.0 B |
| Guam | 0.0 M | 0.1 M | 0.0 T | 0.0 B | 0.0 B |
| Federated States of Micronesia | 0.0 M | 0.1 M | 0.0 T | 0.0 B | 0.0 B |
| Tonga | 0.0 M | 0.1 M | 0.0 T | 0.0 B | 0.0 B |
| American Samoa | 0.0 M | 0.0 M | 0.0 T | 0.0 B | 0.0 B |
| Cook Islands | 0.0 M | 0.0 M | 0.0 T | 0.0 B | 0.0 B |
| Marshall Islands | 0.0 M | 0.0 M | 0.0 T | 0.0 B | 0.0 B |
...
Geoscience Australia. "National Exposure Information System (NEXIS)." (2020). https://www.ga.gov.au/scientific-topics/community-safety/risk-and-impact/nexis

Abbott, Elizabeth, Nick Horspool, Matt Gerstenberger, Rand Huso, Chris Van Houtte, Graeme McVerry, and Silvia Canessa. "Challenges and opportunities in New Zealand seismic hazard and risk modeling using OpenQuake." *Earthquake Spectra 36, no. 1_suppl* (2020): 210-225.
