# 🇦🇺 Australia Exposure Model

This page provides an overview of the exposure model for Australia, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 9.6 million buildings, USD 8.2 trillion in replacement cost, and 26.5 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Australia | COM | 0.2 M |  | 2.5 T | 0.8 B | 396.9 M |
| Australia | IND | 0.2 M |  | 0.4 T | 0.2 B | 93.2 M |
| Australia | RES | 9.2 M | 26.5 M | 5.4 T | 2.9 B | 650.6 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_AUS.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|
| RES | National Exposure Information System (NEXIS) | Geoscience Australia | 2025 | 2025.0 | 5 | Residence type
<br>Building age
<br>Wall materials
<br>Roof materials
<br>Replacement values (structural, contents)
<br>Floor areas
<br>Income level |  | https://www.ga.gov.au/scientific-topics/national-location-information/nexis |
| IND, COM | National Exposure Information System (NEXIS) | Geoscience Australia | 2025 | 2025.0 | 5 | Building type
<br>Building age
<br>Floor area
<br>Replacement values (structural) |  | https://www.ga.gov.au/scientific-topics/national-location-information/nexis |
| OCCUPANTS | National Exposure Information System (NEXIS) | Geoscience Australia | 2025 | 2025.0 | 5 |  |  | https://www.ga.gov.au/scientific-topics/national-location-information/nexis |
| BOUNDARIES | ASGS | Australian Statistical Geography Standard (ASGS) | 2021 |  | 1 to 5 | Administrative divisions from level 1 to 5 | CC BY 4.0 | https://www.abs.gov.au/statistics/standards/australian-statistical-geography-standard-asgs-edition-3/jul2021-jun2026/access-and-downloads/digital-boundary-files |
