# 🇲🇵 Northern_Mariana_Islands Exposure Model

This page provides an overview of the exposure model for Northern_Mariana_Islands, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 9.5 thousand buildings, USD 10.5 billion in replacement cost, and 41.5 thousand occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Northern Mariana Islands | COM | 1.3 K | 0.3 K | 2.7 B | 0.7 M | 377.9 K |
| Northern Mariana Islands | IND | 0.8 K | 0.0 K | 2.2 B | 0.4 M | 214.9 K |
| Northern Mariana Islands | RES | 7.4 K | 41.1 K | 5.5 B | 2.0 M | 657.7 K |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_MNP.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES, IND, COM | 2020 Census data and NSI 2022 | Hazus v6.0 | 2020 | 2025.0 | 2 |  |  |  | Model shared by the USGS. Reference to HAZUS v6.1 |
| OCCUPANTS | Population census | Hazus v6.0 | 2025 | 2025.0 | 2 |  |  |  | Model shared by the USGS. Reference to HAZUS v6.1 |
| BOUNDARIES | United States Census Bureau (2020) | United States Census Bureau (2020) | 2020 |  | 3 | TRACT level. Adjusted to be ADM2 for the territory | Public Domain | https://www2.census.gov/geo/tiger/TIGER2020/TRACT | NAME_1 and ID_1 were updated from HAZUS to the GEM standard |
