...
This page provides an overview of the exposure model for Fiji, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 227.5 thousand buildings, USD 18.3 billion in replacement cost, and 933.2 thousand occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Fiji | COM | 8.0 K |  | 0.7 B | 0.7 M | 0.3 M |
| Fiji | IND | 1.7 K |  | 0.3 B | 0.3 M | 0.1 M |
| Fiji | RES | 217.8 K | 933.2 K | 17.3 B | 16.5 M | 5.0 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_FJI.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
| COMPONENT | DATA_SOURCES | PUBLISHER | DATA_YEAR | ADM_LEVEL | VARIABLES | LINKS | LICENSE | NOTES |
|---|---|---|---|---|---|---|---|---|
| RES | 2017 Population and Housing Census - Administrative Report and General Tables | Fiji Bureau of Statistics | 2017 | 2 | Wall material by province | https://www.statsfiji.gov.fj/census-surveys/census-of-population-and-housing/#2017 |  |  |
| IND, COM | 2017 Population and Housing Census - Infographics Release | Fiji Bureau of Statistics | 2017 | 1 | Registered businesses by industry | https://www.statsfiji.gov.fj/census-surveys/census-of-population-and-housing/#2017 |  |  |
| OCCUPANTS | 2017 Population and Housing Census Release 1 | Fiji Bureau of Statistics | 2017 | 2 | Urban and rural population by province | https://www.statsfiji.gov.fj/census-surveys/census-of-population-and-housing/#2017 |  |  |
| BOUNDARIES | National Geospatial Information Authority | United Nations | 2023 | 1 | Administrative divisions at level 1 | https://salb.un.org/en/data/fji | https://salb.un.org/sites/default/files/wysiwyg_uploads/docs_uploads/TermsOfUseSALB2021.pdf | Rotuma dependency was manually separated. For more information about the original file visit SALB programme, United Nations 2023 |
