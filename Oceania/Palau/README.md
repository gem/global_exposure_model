# 🇵🇼 Palau Exposure Model

This page provides an overview of the exposure model for Palau, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 9.7 thousand buildings, USD 2.5 billion in replacement cost, and 17.7 thousand occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Palau | COM | 0.7 K |  | 0.6 B | 0.4 M | 220.7 K |
| Palau | IND | 0.0 K |  | 0.0 B | 0.0 M | 8.5 K |
| Palau | RES | 9.0 K | 17.7 K | 1.8 B | 1.2 M | 425.9 K |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_PLW.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|
| RES | 2020 Census of Population and Housing of the Republic of Palau | Office of Planning and Statistics | 2020 | 2025.0 | 1 | Main material used for outside walls for occupied housing units per State; Vacant housing units per State |  | https://www.palaugov.pw/executive-branch/ministries/finance/budgetandplanning/census-of-population-and-housing/ |
| IND, COM | 2020 Census of Population and Housing of the Republic of Palau | Office of Planning and Statistics | 2020 | 2025.0 | 0 | Employed persons 16 years and over by industry |  | https://www.palaugov.pw/executive-branch/ministries/finance/budgetandplanning/census-of-population-and-housing/ |
| OCCUPANTS | 2020 Census of Population and Housing of the Republic of Palau | Office of Planning and Statistics | 2020 | 2025.0 | 1 | Population per State |  | https://www.palaugov.pw/executive-branch/ministries/finance/budgetandplanning/census-of-population-and-housing/ |
