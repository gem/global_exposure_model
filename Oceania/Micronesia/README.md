# 🇫🇲 Micronesia Exposure Model

This page provides an overview of the exposure model for Micronesia, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 31.5 thousand buildings, USD 2.3 billion in replacement cost, and 105.6 thousand occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Federated States of Micronesia | COM | 2.2 K |  | 0.4 B | 0.4 M | 154.2 K |
| Federated States of Micronesia | IND | 0.1 K |  | 0.0 B | 0.0 M | 4.5 K |
| Federated States of Micronesia | RES | 29.2 K | 105.6 K | 1.9 B | 1.4 M | 352.6 K |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_FSM.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | 2010 Census of Population and Housing | Statistics Division of the Department of Resources & Development | 2010 | 2025.0 | 1 | Main material of outside walls by state |  | https://stats.gov.fm/topics/social/#11-18-wpfd-population-statistics | While the data source is from 2010, the limited population growth suggests that the model still accurately represent the 2025 reality |
| IND, COM | 2010 Census of Population and Housing Labour Market and Participation | Statistics Division of the Department of Resources & Development | 2010 | 2025.0 | 0 | Employment by industry; Total persons Employed |  | https://stats.gov.fm/topics/economic-statistics/labor-market-and-participation/ | While the data source is from 2010, the limited population growth suggests that the model still accurately represent the 2025 reality |
| OCCUPANTS | Population projections 2020-2025 | Statistics Division of the Department of Resources & Development | 2025 | 2025.0 | 1 | Population by state 2025 projections |  | https://stats.gov.fm/topics/social/#11-18-wpfd-population-statistics |  |
