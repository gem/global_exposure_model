# 🇳🇿 New_Zealand Exposure Model

This page provides an overview of the exposure model for New_Zealand, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 2.5 million buildings, USD 1.4 trillion in replacement cost, and 5.3 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| New Zealand | NONRES | 0.7 M |  | 511.6 B | 189.5 M | 65.2 M |
| New Zealand | RES | 1.8 M | 5.3 M | 843.3 B | 374.7 M | 57.1 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_NZL.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|
| RES | 2023 Census, Building Consents | Stats NZ | 2025 | 2025.0 | 5 | Dwellings |  | https://www.stats.govt.nz/ |
| NONRES | Exposure model | GNS Science | 2021 | 2025.0 | 3, 0.05x0.05 degrees grid |  |  | www.gns.cri.nz |
| OCCUPANTS | 2023 Census,2025 estimate | Stats NZ | 2025 | 2025.0 | 2 |  |  | https://www.stats.govt.nz/ |
