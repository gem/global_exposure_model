...
This page provides an overview of the exposure model for Niue, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 1.5 thousand buildings, USD 340.0 million in replacement cost, and 1.8 thousand occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Niue | COM | 0.1 K |  | 34.4 M | 19.6 K | 6.7 K |
| Niue | IND | 0.0 K |  | 4.0 M | 3.5 K | 0.7 K |
| Niue | RES | 1.4 K | 1.8 K | 301.6 M | 166.6 K | 37.8 K |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_NIU.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|
| RES | 2022 Niue Census of Population and Housing Report | Niue Statistics Office | 2022 | 2025.0 | 1 | Materials used for construction of walls; Private occupied households and average household size by village |  | https://niuestatistics.nu/census/population-housing/ |
| IND, COM | 2022 Niue Census of Population and Housing Report | Niue Statistics Office | 2022 | 2025.0 | 0 | Status in employment; Percentage of labor force per industry |  | https://niuestatistics.nu/census/population-housing/ |
| OCCUPANTS | 2022 Niue Census of Population and Housing Report | Niue Statistics Office | 2022 | 2025.0 | 1 | Population percentage per village |  | https://niuestatistics.nu/census/population-housing/ |
