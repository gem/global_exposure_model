# 🇲🇭 Marshall_Islands Exposure Model

This page provides an overview of the exposure model for Marshall_Islands, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 10.5 thousand buildings, USD 1.4 billion in replacement cost, and 36.3 thousand occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Marshall Islands | COM | 0.5 K |  | 0.2 B | 182.2 K | 90.3 K |
| Marshall Islands | IND | 0.1 K |  | 0.0 B | 30.8 K | 13.7 K |
| Marshall Islands | RES | 9.9 K | 36.3 K | 1.2 B | 879.2 K | 312.0 K |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_MHL.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|
| RES | 2021 Census Report Volume 1 | Pacific Community (SPC), the Marshall Islands Economic Policy, Planning and Statistics Office | 2021 | 2025.0 | 1 | Private dwelling HH by island by main material of wall; Private dwelling HH by island by type of living quarters |  | https://sdd.spc.int/digital_library/republic-marshall-islands-2021-census-report-volume-1-basic-tables-and |
| IND, COM | 2021 Census Report Volume 1 | Pacific Community (SPC), the Marshall Islands Economic Policy, Planning and Statistics Office | 2021 | 2025.0 | 0 | Employed population by industry group |  | https://sdd.spc.int/digital_library/republic-marshall-islands-2021-census-report-volume-1-basic-tables-and |
| OCCUPANTS | 2021 Census Report Volume 1 | Pacific Community (SPC), the Marshall Islands Economic Policy, Planning and Statistics Office | 2021 | 2025.0 | 1 | Population by atol/island |  | https://sdd.spc.int/digital_library/republic-marshall-islands-2021-census-report-volume-1-basic-tables-and |
