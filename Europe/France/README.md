# 🇫🇷 France Exposure Model

This page provides an overview of the exposure model for France, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 16.4 million buildings, USD 8.6 trillion in replacement cost, and 66.6 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| France | COM | 0.6 M |  | 1.1 T | 0.5 B | 0.2 B |
| France | IND | 0.3 M |  | 1.1 T | 0.7 B | 0.2 B |
| France | RES | 15.4 M | 66.6 M | 6.4 T | 3.2 B | 1.1 B |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_FRA.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | 2014 Population and Housing Census |  | 2014 | 2025.0 | 5 | Dwelling type with year of constructionUrban/rural/historic |  | https://www.insee.fr | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| OCCUPANTS | 2014 Population and Housing Census, World Bank Development Indicators (WDI) 2019 |  | 2014, 2019 | 2025.0 | 5 |  |  | https://www.insee.fr | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| COM | Eurostat 2015 |  | 2015 | 2025.0 | 2 |  |  | http://bit.ly/2GjGHMW<br>2014 Population and Housing Census<br>https://www.insee.fr | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
...
| BOUNDARIES | GeoBoundaries | GeoBoundaries | 2025 |  | 1 | Administrative divisions at level 1 | CC BY 4.0 | https://www.geoboundaries.org/countryDownloads.html | Adm1 divisions match the source. Finer model levels correspond to the previous version, adjusted to the new Adm1. |
