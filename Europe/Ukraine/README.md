# 🇺🇦 Ukraine Exposure Model

This page provides an overview of the exposure model for Ukraine, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 13.9 million buildings, USD 1.1 trillion in replacement cost, and 39.0 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Ukraine | COM | 0.3 M |  | 157.6 B | 0.2 B | 105.1 M |
| Ukraine | IND | 0.2 M |  | 156.7 B | 0.2 B | 76.4 M |
| Ukraine | RES | 13.3 M | 39.0 M | 815.9 B | 1.4 B | 487.4 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_UKR.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
| IND | GEM Foundation |  | 2000 | 2025.0 | 2 |  |  | https://www.gemfoundation.org | The model year is indicative because of missing information in the source data. |
