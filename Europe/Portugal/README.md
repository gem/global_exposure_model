# 🇵🇹 Portugal Exposure Model

This page provides an overview of the exposure model for Portugal, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 4.1 million buildings, USD 1.3 trillion in replacement cost, and 10.4 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Portugal | COM | 0.2 M |  | 0.1 T | 85.6 M | 38.9 M |
| Portugal | IND | 0.1 M |  | 0.1 T | 76.5 M | 25.8 M |
| Portugal | RES | 3.8 M | 10.4 M | 1.1 T | 744.1 M | 238.2 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_PRT.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | 2021 Population and Housing Census |  | 2021 | 2025.0 | 3 |  |  | https://ine.pt | Details available at: https://doi.org/10.1007/s10518-024-01975-0. |
| OCCUPANTS | 2021 Population and Housing Census |  | 2021 | 2025.0 | 3 |  |  | https://ine.pt | Details available at: https://doi.org/10.1007/s10518-024-01975-0. |
| COM | 2011 Population and Housing Census |  | 2011 | 2025.0 | 3 |  |  | https://ine.pt | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
...
| BOUNDARIES | World Bank | World Bank | 2025 |  | 1 | Administrative divisions at level 1 | CC BY 4.0 | https://datacatalog.worldbank.org/search/dataset/0038272/world-bank-official-boundaries | In the GPKG file, ADM1 regions in the mainland remain unchanged; island units were grouped into the two autonomous island regions: Azores and Madeira. |
