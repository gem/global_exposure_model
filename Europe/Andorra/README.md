# 🇦🇩 Andorra Exposure Model

This page provides an overview of the exposure model for Andorra, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 21.2 thousand buildings, USD 9.8 billion in replacement cost, and 82.9 thousand occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Andorra | COM | 4.5 K |  | 3.5 B | 1.9 M | 887.4 K |
| Andorra | IND | 1.3 K |  | 1.5 B | 0.9 M | 279.5 K |
| Andorra | RES | 15.4 K | 82.9 K | 4.8 B | 2.6 M | 896.0 K |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_AND.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
| COM | 2017 Structural Business Statistics / Services, commerce, hotel and tourism |  | 2017 | 2025.0 | 1 |  |  | https://www.estadistica.ad/serveiestudis/web/index.asp | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| IND | Enterprises: 2017 Structural Business Statistics / Construction, Industry and Energy |  | 2017 | 2025.0 | 1 |  |  | Enterprises: https://www.estadistica.ad/serveiestudis/web/index.asp | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
