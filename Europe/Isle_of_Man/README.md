# 🇮🇲 Isle_of_Man Exposure Model

This page provides an overview of the exposure model for Isle_of_Man, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 21.5 thousand buildings, USD 12.6 billion in replacement cost, and 84.1 thousand occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Isle of Man | COM | 3.7 K |  | 4.4 B | 1.6 M | 0.7 M |
| Isle of Man | IND | 1.0 K |  | 0.7 B | 0.3 M | 0.1 M |
| Isle of Man | RES | 16.8 K | 84.1 K | 7.5 B | 3.5 M | 1.3 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_IMN.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | GED4GEM | GEM Foundation | 2012 | 2025.0 | 0 |  |  | https://www.gemfoundation.org | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| OCCUPANTS | GED4GEM, World Bank Development Indicators (WDI) 2019 | GEM Foundation | 2012, 2019 | 2025.0 | 0 |  |  | https://www.gemfoundation.org | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| COM | 2016 Statistics |  | 2016 | 2025.0 | 0 |  |  | https://www.gov.im | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| IND | Buildings: 2016 National Census |  | 2016 | 2025.0 | 2 |  |  | Buildings: https://www.gov.im/census/ <br>https://www.gov.im/about-the-government/departments/cabinet-office/economic-affairs-division/ | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| BOUNDARIES | OSM | Geofabrik | 2025 |  | 1 | Administrative divisions at level 1 | ODbL | https://download.geofabrik.de/europe/isle-of-man.html | In the previous model, the layer labeled ADM2 in the GPKG actually corresponds to ADM1 under the standard classification. Compared to the earlier version, the number of divisions is reduced due to administrative mergers: Laxey, Lonan, and Maughold merged into Garff in 2016, and Arbory and Rushen merged in 2020. |
