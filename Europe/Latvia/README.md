# 🇱🇻 Latvia Exposure Model

This page provides an overview of the exposure model for Latvia, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 416.1 thousand buildings, USD 134.0 billion in replacement cost, and 1.9 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Latvia | COM | 22.1 K |  | 21.1 B | 14.7 M | 6.3 M |
| Latvia | IND | 14.0 K |  | 26.6 B | 22.0 M | 7.2 M |
| Latvia | RES | 379.9 K | 1.9 M | 86.3 B | 64.8 M | 20.0 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_LVA.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | GED4GEM | GEM Foundation | 2012 | 2025.0 | 1 |  |  | https://www.gemfoundation.org | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| OCCUPANTS | 2009 Population and Housing Census<br>, World Bank Development Indicators (WDI) 2019 |  | 2009, 2019 | 2025.0 | 1 |  |  | http://www.csb.gov.lv | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| COM | Eurostat 2011 |  | 2011 | 2025.0 | 1 |  |  | https://ec.europa.eu/energy/en/eu-buildings-database<br>2009 Population and Housing Census<br>http://www.csb.gov.lv | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
...
| BOUNDARIES | GeoBoundaries | GeoBoundaries | 2025 |  | 1 | Administrative divisions at level 1 | CC BY 4.0 | https://www.geoboundaries.org/countryDownloads.html | The country moved from ADM1 provinces to municipalities, increasing the number of administrative divisions from 5 to 43. The GeoBoundaries GPKG was not modified; the models were adapted to the new ADM1 structure |
