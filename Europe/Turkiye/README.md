# 🇹🇷 Turkiye Exposure Model

This page provides an overview of the exposure model for Turkiye, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 10.1 million buildings, USD 1.7 trillion in replacement cost, and 87.7 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Türkiye | COM | 0.8 M |  | 0.3 T | 0.4 B | 166.1 M |
| Türkiye | IND | 0.2 M |  | 0.1 T | 0.3 B | 111.1 M |
| Türkiye | RES | 9.1 M | 87.7 M | 1.3 T | 3.0 B | 994.0 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_TUR.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
| COMPONENT | DATA_SOURCES | PUBLISHER | DATA_YEAR | UPDATE_YEAR | ADM_LEVEL | VARIABLES | LICENSE | LINKS |
|---|---|---|---|---|---|---|---|---|
| RES, COM, IND | Bina Sayımı (Building Census) of Turkey - 2000<br>Building Permit Statistics from 2001-2023<br>Address Based Population Registration System (ABPRS) - 2023 | Başbakanlık Devlet İstatistik Enstitüsü<br>Türkiye İstatistik Kurumu (TÜİK / TurkStat) | 2000<br>2001-2023<br>2023 | 2025.0 | 1, 4 | Bina Sayımı (Building Census) - Adm1:<br> - Occupancy class<br> - Primary use class<br> - Number of stories<br> - Floor areas<br> - Structural system and primary material of construction<br> - Decade of construction<br><br>Building Permit Statistics - Adm1:<br> - Occupancy class<br> - Primary use class<br> - Year of construction<br><br>Population - Adm4 |  | https://biruni.tuik.gov.tr/medas/?kn=135&locale=en<br>https://data.tuik.gov.tr/Bulten/Index?p=The-Results-of-Address-Based-Population-Registration-System-2023-49684&dil=2 |
| OCCUPANTS | Address Based Population Registration System (ABPRS) | Türkiye İstatistik Kurumu (TÜİK / TurkStat) |  | 2025.0 | 4 | Population |  | https://data.tuik.gov.tr/Bulten/Index?p=The-Results-of-Address-Based-Population-Registration-System-2023-49684&dil=2 |
| COSTS | Local research |  |  | 2025.0 |  |  |  |  |
