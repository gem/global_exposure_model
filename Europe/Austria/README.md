# 🇦🇹 Austria Exposure Model

This page provides an overview of the exposure model for Austria, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 2.5 million buildings, USD 1.2 trillion in replacement cost, and 9.1 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Austria | COM | 0.1 M |  | 250.7 B | 107.7 M | 50.5 M |
| Austria | IND | 0.0 M |  | 2.9 B | 1.6 M | 0.5 M |
| Austria | RES | 2.4 M | 9.1 M | 912.0 B | 487.8 M | 163.6 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_AUT.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | 2011 Population and Housing Census |  | 2011 | 2025.0 | 1 | Material with year of constructionUrban/rural |  | http://www.statistik.at | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| OCCUPANTS | 2011 Population and Housing Census, World Bank Development Indicators (WDI) 2019 |  | 2011, 2019 | 2025.0 | 1 |  |  | http://www.statistik.at | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| COM | 2011 Population and Housing Census |  | 2011 | 2025.0 | 1 |  |  | http://www.statistik.at | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
