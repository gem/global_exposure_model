# 🇬🇮 Gibraltar Exposure Model

This page provides an overview of the exposure model for Gibraltar, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 5.7 thousand buildings, USD 4.6 billion in replacement cost, and 40.1 thousand occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Gibraltar | COM | 1.5 K |  | 2.3 B | 764.5 K | 316.6 K |
| Gibraltar | IND | 0.1 K |  | 0.2 B | 54.4 K | 16.4 K |
| Gibraltar | RES | 4.2 K | 40.1 K | 2.2 B | 796.0 K | 271.5 K |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_GIB.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
| COMPONENT | DATA_SOURCES | PUBLISHER | DATA_YEAR | UPDATE_YEAR | ADM_LEVEL | LICENSE | LINKS | NOTES |
|---|---|---|---|---|---|---|---|---|
| RES | GED4GEM | GEM Foundation | 2012 | 2025.0 | 0 |  | https://www.gemfoundation.org | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. Models originally at ADM0 were downscaled to ADM1 by distributing assets proportionally using population data from the 2022 census by major residential areas (Gibraltar Census 2022). |
| OCCUPANTS | GED4GEM (REF_RES1), World Bank Development Indicators (WDI) 2019 |  | 2012, 2019 | 2025.0 | 0 |  | https://www.gemfoundation.org | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| COM | 2012 Population and Housing Census |  | 2012 | 2025.0 | 0 |  | https://www.gibraltar.gov.gi | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure.Models originally at ADM0 were downscaled to ADM1 by distributing assets proportionally using population data from the 2022 census by major residential areas (Gibraltar Census 2022). |
| IND | Buildings: 2012 Population and Housing Census |  | 2012 | 2025.0 | 0 |  | Buildings: http://bit.ly/2GrhPD3<br>http://bit.ly/2FPhTP4 | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure.Models originally at ADM0 were downscaled to ADM1 by distributing assets proportionally using population data from the 2022 census by major residential areas (Gibraltar Census 2022). |
| BOUNDARIES | Cesus of Gibraltar 2022 | Statistics Office HM Goverment of Gibraltar | 2022 |  | 1 | https://www.geoportal.gov.gi/index.php/downloads/disclaimer | https://www.gibraltar.gov.gi/statistics/downloads | The map at the Major Residential Areas level was manually constructed using the 2022 census enumeration areas and the corresponding official shapefile for those enumerated areas. Disclaimer: `Unless otherwise specified, access to information on the Geoportal does not imply a license to reproduce and/or distribute information without the prior approval of HM Government of Gibraltar` |
