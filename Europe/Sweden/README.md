# 🇸🇪 Sweden Exposure Model

This page provides an overview of the exposure model for Sweden, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 2.8 million buildings, USD 1.8 trillion in replacement cost, and 10.7 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Sweden | COM | 0.3 M |  | 0.3 T | 113.5 M | 48.1 M |
| Sweden | IND | 0.1 M |  | 0.3 T | 148.1 M | 43.5 M |
| Sweden | RES | 2.4 M | 10.7 M | 1.1 T | 442.8 M | 126.6 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_SWE.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
| OCCUPANTS | 2011 Population and Housing Census<br>, World Bank Development Indicators (WDI) 2019 |  | 2011, 2019 | 2025.0 | 2 |  |  | http://www.statistikdatabasen.scb.se | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| COM | Eurostat 2011 |  | 2011 | 2025.0 | 2 |  |  | https://ec.europa.eu/energy/en/eu-buildings-database<br>2011 Population and Housing Census<br>http://www.statistikdatabasen.scb.se | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
