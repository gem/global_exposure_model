# 🇧🇪 Belgium Exposure Model

This page provides an overview of the exposure model for Belgium, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 4.1 million buildings, USD 1.4 trillion in replacement cost, and 11.8 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Belgium | COM | 0.1 M |  | 290.5 B | 134.8 M | 60.1 M |
| Belgium | IND | 0.1 M |  | 264.7 B | 181.2 M | 57.5 M |
| Belgium | RES | 4.0 M | 11.8 M | 800.7 B | 455.5 M | 165.5 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_BEL.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | 2011 Population and Housing Census |  | 2011 | 2025.0 | 4 | Dwelling type with year of constructionUrban/rural |  | http://census2011.fgov.be | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| OCCUPANTS | 2011 Population and Housing Census, World Bank Development Indicators (WDI) 2019 |  | 2011, 2019 | 2025.0 | 4 |  |  | http://census2011.fgov.be | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| COM | Eurostat 2011 |  | 2011 | 2025.0 | 2 |  |  | https://ec.europa.eu/energy/en/eu-buildings-database<br>2011 Population and Housing Census: https://statbel.fgov.be | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
