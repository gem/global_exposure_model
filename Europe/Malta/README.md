# 🇲🇹 Malta Exposure Model

This page provides an overview of the exposure model for Malta, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 122.9 thousand buildings, USD 47.7 billion in replacement cost, and 545.4 thousand occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Malta | COM | 14.4 K |  | 3.8 B | 2.5 M | 1.1 M |
| Malta | IND | 10.8 K |  | 7.7 B | 5.2 M | 1.8 M |
| Malta | RES | 97.7 K | 545.4 K | 36.2 B | 25.0 M | 8.9 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_MLT.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | 2005 Population and Housing Census |  | 2005 | 2025.0 | 1 | Year of constructionRural |  | https://nso.gov.mt | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| OCCUPANTS | 2005 Population and Housing Census , World Bank Development Indicators (WDI) 2019 |  | 2005, 2019 | 2025.0 | 1 |  |  | https://nso.gov.mt | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| COM | Eurostat 2011 |  | 2011 | 2025.0 | 1 |  |  | https://ec.europa.eu/energy/en/eu-buildings-database<br>2005 Population and Housing Census <br>https://nso.gov.mt | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| IND | Enterprises: 2013 Structural Business Statistics,<br>Areas: Sousa et al. (2017) |  | 2013 | 2025.0 | 30 arc seconds |  |  | Enterprises: http://bit.ly/2FMSS75,<br>Areas: https://doi.org/10.1193/020316eqs027m | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
