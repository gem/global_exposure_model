# 🇲🇨 Monaco Exposure Model

This page provides an overview of the exposure model for Monaco, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 10.2 thousand buildings, USD 11.9 billion in replacement cost, and 38.3 thousand occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Monaco | COM | 0.8 K |  | 2.8 B | 0.6 M | 280.1 K |
| Monaco | IND | 0.2 K |  | 0.4 B | 0.1 M | 39.0 K |
| Monaco | RES | 9.2 K | 38.3 K | 8.7 B | 2.1 M | 750.5 K |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_MCO.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
| COM | 2016 Statistics |  | 2016 | 2025.0 | 0 |  |  | https://www.monacostatistics.mc/ | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure.Models originally at ADM0 were downscaled to ADM1 by distributing assets proportionally using population data from the 2024 census by major residential areas (Monaco Census 2024). |
| IND | Enterprises: 2015 Structural Business Statistics |  | 2015 | 2025.0 | 0 |  |  | Enterprises: http://bit.ly/2DokWsa | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure.Models originally at ADM0 were downscaled to ADM1 by distributing assets proportionally using population data from the 2024 census by major residential areas (Monaco Census 2024). |
