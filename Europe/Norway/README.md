# 🇳🇴 Norway Exposure Model

This page provides an overview of the exposure model for Norway, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 1.9 million buildings, USD 1.6 trillion in replacement cost, and 5.6 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Norway | COM | 0.1 M |  | 0.2 T | 50.3 M | 18.5 M |
| Norway | IND | 0.1 M |  | 0.1 T | 41.9 M | 12.4 M |
| Norway | RES | 1.7 M | 5.6 M | 1.3 T | 346.5 M | 86.8 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_NOR.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | 2017 Population and Housing Census |  | 2017 | 2025.0 | 2 | Number of floorsUrban/rural |  | https://www.ssb.no | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| OCCUPANTS | 2017 Population and Housing Census , World Bank Development Indicators (WDI) 2019 |  | 2017, 2019 | 2025.0 | 2 |  |  | 2017 Population and Housing Census | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| COM | 2017 Population and Housing Census |  | 2017 | 2025.0 | 1 |  |  | https://www.ssb.no | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| IND | Buildings: 2017 Population and Housing Census,<br>Areas: Sousa et al. (2017) |  | 2017 | 2025.0 | 30 arc seconds |  |  | Buildings: https://www.ssb.no,<br>Areas: https://doi.org/10.1193/020316eqs027m | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| BOUNDARIES | Administrative enheter fylker | Kartverket (Geonorge) | 2025 |  | 1 | Administrative divisions at level 1 | CC BY 4.0 | https://kartkatalog.geonorge.no/metadata/administrative-enheter-fylker/6093c8a8-fa80-11e6-bc64-92361f002671 | Adm1 boundaries are clipped to land using World Bank Official Boundaries v5 - NOR |
