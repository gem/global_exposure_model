# 🇱🇺 Luxembourg Exposure Model

This page provides an overview of the exposure model for Luxembourg, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 158.8 thousand buildings, USD 143.2 billion in replacement cost, and 680.5 thousand occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Luxembourg | COM | 11.2 K |  | 38.1 B | 13.5 M | 6.0 M |
| Luxembourg | IND | 2.4 K |  | 12.5 B | 5.8 M | 1.9 M |
| Luxembourg | RES | 145.2 K | 680.5 K | 92.6 B | 31.6 M | 10.8 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_LUX.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
| OCCUPANTS | 2001 Population and Housing Census<br>, World Bank Development Indicators (WDI) 2019 |  | 2001, 2019 | 2025.0 | 2 |  |  | http://www.statistiques.public.lu | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| COM | Eurostat 2011 |  | 2011 | 2025.0 | 2 |  |  | https://ec.europa.eu/energy/en/eu-buildings-database<br>2001 Population and Housing Census<br>http://www.statistiques.public.lu | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
...
| BOUNDARIES | GeoBoundaries | GeoBoundaries | 2025 |  | 1 | Administrative divisions at level 1 | CC BY 4.0 | https://www.geoboundaries.org/countryDownloads.html | The former Adm2 level previously used by the model actually corresponds to Adm1. The GeoBoundaries Adm1 GPKG file was not modified, and the model was adapted to match this |
