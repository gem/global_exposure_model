# 🇨🇭 Switzerland Exposure Model

This page provides an overview of the exposure model for Switzerland, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 1.9 million buildings, USD 4.6 trillion in replacement cost, and 9.0 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Switzerland | COM | 0.1 M |  | 0.5 T | 113.8 M | 49.3 M |
| Switzerland | IND | 0.1 M |  | 0.3 T | 112.3 M | 37.9 M |
| Switzerland | RES | 1.8 M | 9.0 M | 3.8 T | 888.0 M | 277.4 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_CHE.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | Buildings, dwellings: 2016 Population and Housing Census, Areas: ERM-CH23 based on volume/3 |  | 2023 | 2025.0 | 3 | Year of construction and dwelling typeUrban/rural |  | https://bit.ly/2DQEea2 | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| OCCUPANTS | Occupants: 2016 Population and Housing Census, World Bank Development Indicators (WDI) 2019 |  | 2023, 2019 | 2025.0 | 3 |  |  | https://bit.ly/2DQEea3 | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| COM | Enterprises: 2016 Population and Housing Census, Areas: ERM-CH23 |  | 2023 | 2025.0 | 1 |  |  | https://bit.ly/2DQEea2 | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| IND | Enterprises: Eurostat 2014,<br>Buildings: ERM-CH23,<br>Areas: ERM-CH23 based on volume/4.5 |  | 2023 | 2025.0 | 30 arc seconds |  |  | Enterprises: http://bit.ly/2GjGHMW,<br>Buildings: ERM-CH23,<br>Areas: ERM-CH23 based on volume/4.5 | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
