# 🇲🇰 North_Macedonia Exposure Model

This page provides an overview of the exposure model for North_Macedonia, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 605.4 thousand buildings, USD 44.5 billion in replacement cost, and 1.8 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| North Macedonia | COM | 42.5 K |  | 9.8 B | 14.7 M | 6.1 M |
| North Macedonia | IND | 13.3 K |  | 6.0 B | 11.3 M | 4.1 M |
| North Macedonia | RES | 549.6 K | 1.8 M | 28.7 B | 62.3 M | 20.7 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_MKD.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | 2002 Population and Housing Census |  | 2002 | 2025.0 | 1 | Year of constructionUrban/rural |  | http://www.stat.gov.mk | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| OCCUPANTS | 2002 Population and Housing Census, World Bank Development Indicators (WDI) 2019 |  | 2002, 2019 | 2025.0 | 1 |  |  | http://www.stat.gov.mk | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| COM | 2009 Statistics |  | 2009 | 2025.0 | 1 |  |  | http://www.stat.gov.mk | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| IND | Enterprises: 2016 Structural Business Statistics,<br>Areas: Sousa et al. (2017) |  | 2016 | 2025.0 | 30 arc seconds |  |  | Enterprises: http://bit.ly/2Hsdyi7,<br>Areas: https://doi.org/10.1193/020316eqs027m | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| BOUNDARIES | World Bank | World Bank | 2025 |  | 1 | Administrative divisions at level 1 | CC BY 4.0 | https://datacatalog.worldbank.org/search/dataset/0038272/world-bank-official-boundaries | In the previous model, the level labeled Adm1 actually corresponded to Adm2. The true Adm1 level was added and models were updated accordingly. The current Adm1 mainly represents a statistical division, while governmental use corresponds to the municipality level (Adm2). |
