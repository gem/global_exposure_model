# 🇧🇾 Belarus Exposure Model

This page provides an overview of the exposure model for Belarus, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 2.1 million buildings, USD 215.3 billion in replacement cost, and 9.0 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Belarus | COM | 0.1 M |  | 21.8 B | 31.2 M | 13.1 M |
| Belarus | IND | 0.0 M |  | 15.9 B | 23.8 M | 8.6 M |
| Belarus | RES | 2.0 M | 9.0 M | 177.6 B | 344.0 M | 117.7 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_BLR.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | GEM Foundation |  | 2000 | 2025.0 | 2 |  |  | https://www.gemfoundation.org | The model year is indicative because of missing information in the source data. |
| OCCUPANTS |  |  | 2000 | 2025.0 | 2 |  |  |  | The model year is indicative because of missing information in the source data. |
| COM | GEM Foundation |  | 2000 | 2025.0 | 1 |  |  | https://www.gemfoundation.org | The model year is indicative because of missing information in the source data. |
| IND | GEM Foundation |  | 2000 | 2025.0 | 1 |  |  | https://www.gemfoundation.org | The model year is indicative because of missing information in the source data. |
| BOUNDARIES | GeoBoundaries | GeoBoundaries | 2025 |  | 1 | Administrative divisions at level 1 | CC BY 4.0 | https://www.geoboundaries.org/countryDownloads.html | The Adm2 GPKG was manually modified to include Minsk City and ensure consistency with Adm1 from GeoBoundaries. The Adm1 gpkg from GeoBoundaries that was used remains unaltered. |
