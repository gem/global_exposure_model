# 🇪🇸 Spain Exposure Model

This page provides an overview of the exposure model for Spain, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 10.9 million buildings, USD 4.4 trillion in replacement cost, and 47.9 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Spain | COM | 0.5 M |  | 0.3 T | 0.2 B | 100.5 M |
| Spain | IND | 0.2 M |  | 0.4 T | 0.3 B | 104.1 M |
| Spain | RES | 10.1 M | 47.9 M | 3.7 T | 2.5 B | 856.1 M |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_ESP.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | 2011 Population and Housing Census |  | 2011 | 2025.0 | 2 | Year of construction and number of floorsUrban/rural |  | http://www.ine.es | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| OCCUPANTS | 2011 Population and Housing Census, World Bank Development Indicators (WDI) 2019 |  | 2011, 2019 | 2025.0 | 2 |  |  | http://www.ine.es | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| COM | Eurostat 2015 |  | 2015 | 2025.0 | 1 |  |  | http://bit.ly/2GjGHMW<br>2011 Population and Housing Census<br>http://www.ine.es | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| IND | Buildings: ECOFYS,<br>Areas: Sousa et al. (2017) |  | 2011 | 2025.0 | 30 arc seconds |  |  | Buildings: https://leonardo-energy.pl/wp-content/uploads/2018/03/Europejski-sektor-budownictwa-niemieszkalnego.pdf),<br>Areas: https://doi.org/10.1193/020316eqs027m | The current model uses v1.0 from  The European Seismic Risk Model (2020) project. Available in the public repository https://gitlab.seismo.ethz.ch/efehr/esrm20_exposure. |
| BOUNDARIES | GeoBoundaries | GeoBoundaries | 2025 |  | 1 | Administrative divisions at level 1 | CC BY 4.0 | https://www.geoboundaries.org/countryDownloads.html | Administrative Level 1 for mainland Spain remains unchanged. The updated target-source GPKG included after standardization now incorporates the Canary Islands and separates Ceuta and Melilla into individual features, whereas they were previously grouped under the same feature/tag. |
