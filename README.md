...
| [v2023.1.0](https://github.com/gem/global_exposure_model/tree/v2023.1.0) | Update exposure model with GEM global model release June 2023. It includes:<ul><li>The USA model updated with FEMA 2023</li><li>Turkey updated after M7.8_Kahramanmaras-Gaziantep earthquake</li><li>Minor adjustment to ensure consistent boundary names</li><li>Minor adjustments in taxonomy strings for additional GEM vulnerability functions.</li></ul> |
