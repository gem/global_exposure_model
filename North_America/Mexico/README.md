# 🇲🇽 Mexico Exposure Model

This page provides an overview of the exposure model for Mexico, including national totals, predominant building classes, and subnational distribution.
...
The exposure model includes the distribution of buildings, replacement value, exposed population and embodied carbon. The total exposure includes 23.8 million buildings, USD 5.2 trillion in replacement cost, and 128.5 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 7. See [Adm0 summary table](summaries/Exposure_Summary_Adm0.csv) for additional national level metrics.
...
|---|---|---|---|---|---|---|
| Mexico | COM | 4.7 M |  | 0.9 T | 0.9 B | 0.4 B |
| Mexico | IND | 0.7 M |  | 0.2 T | 0.2 B | 0.1 B |
| Mexico | RES | 18.5 M | 128.5 M | 4.2 T | 4.8 B | 1.5 B |
...
For the complete list of building classes in the country or territory, see [Taxonomy summary table](summaries/Exposure_Summary_Taxonomy.csv). Each building class is linked to a corresponding vulnerability class through a vulnerability mapping, available as `Vulnerability_mapping_MEX.csv`, following the definitions of the [GEM Global Vulnerability Model](https://github.com/gem/global_vulnerability_model).
...
|---|---|---|---|---|---|---|---|---|---|
| RES | Population and Housing Census | Instituto Nacional de Estadí­stica y Geografía - INEGI | 2020 | 2025.0 | 3 | Population, dwellings, wall material, type of settlement |  | https://www.inegi.org.mx/programas/ccpv/2020/#tabulados | Models were brought to 2025 by using the country's latest projections for adm level 2. The models are actually at an administrative level smaller than level 3; they are at the census locality level. There are differences in administrative divisions between the residential and commercial models, since after 2020 some divisions were modified to create new ones. The new municipalities created after 2020 are: Dzitbalché (Campeche), INEGI code 04013, split from Calkiní (04001); Las Vigas (Guerrero), 12082, split from San Marcos (12053); Santa Cruz del Rincón (Guerrero), 12084, split from Malinaltepec (12041); San Nicolás (Guerrero), 12085, split from Cuajinicuilapa (12023); Ñuu Savi (Guerrero), 12083, split from Ayutla de los Libres (12012); Eldorado (Sinaloa), 25019, split from Culiacán (25003); Juan José Ríos (Sinaloa), 25020, formed from Ahome (25004), Guasave (25007), El Fuerte (25014), and Sinaloa (25012); San Felipe (Baja California), 02007, split from Mexicali (02002) and Ensenada (02001); and Villa de Pozos (San Luis Potosí), 24059, split from San Luis Potosí (24028). |
...
| OCCUPANTS | Reconstrucción y proyecciones de la población de los municipios de México | Gobierno de Mexico | 2025 | 2025.0 | 2 | Population projections |  | https://www.gob.mx/cms/uploads/attachment/file/918028/BD_municipales_portada_regiones_FINAL.pdf<br>https://www.gob.mx/conapo/articulos/reconstruccion-y-proyecciones-de-la-poblacion-de-los-municipios-de-mexico?idiom=es |  |
| IND, COM | Censos Economicos | Instituto Nacional de Estadí­stica y Geografía - INEGI | 2024 | 2025.0 | 3 | number of establishments, economical activity macro-micro, locations point by point |  | https://www.inegi.org.mx/programas/ce/2024/#tabulados | The models were aggregated at the locality level for consistency with the residential model; the source data are point-by-point or company-by-company with coordinates. https://www.inegi.org.mx/programas/ce/2024/#tabulados |
