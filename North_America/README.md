...
# North America Exposure Model

## ✨ Overview

> The `v2026.0.0` release for the North America exposure model is now available! 🥳 🚀

This repository contains the latest exposure model files for the countries and territories in **North America**.
...
| COUNTRY | ISO3 |
|---------|------|
| [Canada](Canada/README.md) | CAN |
| [Mexico](Mexico/README.md) | MEX |
| [United_States](United_States/README.md) | USA |
</details>

## 📊 Regional summary

The regional exposure includes the distribution of buildings, replacement value, and exposed population across all countries in **North America**. The regional exposure includes 156.1 million buildings, USD 114.3 trillion in replacement cost, and 493.9 million occupants. The figure below shows the spatial distribution of building counts aggregated onto a discrete hexagonal grid at H3 resolution 5. See [Adm0 summary table](_region/Exposure_North_America_Adm0.csv) for additional national level metrics.
...
_Table: Regional exposure model summary per country in North America. See [Adm0 summary table](_region/Exposure_North_America_Adm0.csv) for the comple list of national level metrics._

| COUNTRY | BUILDINGS | OCCUPANTS | REPLACEMENT COST (USD) | BUILT-UP AREA (SQM) | EMBODIED CARBON (TON) |
|---|---|---|---|---|---|
| United States | 121.4 M | 325.4 M | 105.0 T | 30.4 B | 7.0 B |
| Mexico | 23.8 M | 128.5 M | 5.2 T | 5.9 B | 2.0 B |
| Canada | 10.8 M | 40.0 M | 4.1 T | 1.8 B | 0.5 B |
...
Journeay, M., Lesueur, P., Chow, W., & Wagner, C. (2022). Geological Survey of Canada Open File Report 8892. Physical exposure to natural hazards in Canada. https://doi.org/10.4095/330012

U.S. Army Corps of Engineers (USACE) Hydrologic Engineering Center (HEC). *National Structure Inventory (NSI) 2022*. https://www.hec.usace.army.mil/confluence/nsi
